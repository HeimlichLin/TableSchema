...
public class PoPageImpl implements PageMain {

	private final TableDTO dto;

	public PoPageImpl(TableDTO dto) {
		this.dto = dto;
	}
	...
	public String getPackageString() {
		return "package com.doc.common.po.impl; \n \n";
	}
	...
	private String getEnumColumnsString() {
		...
		for (int i = 0; i < this.dto.getList().size(); i++) {
			sb.append("		"
					+ this.dto.getList().get(i).getColumnName().toUpperCase()
	...
	private String getVariableString() {
		final StringBuilder sb = new StringBuilder();
		for (int i = 0; i < this.dto.getList().size(); i++) {
			sb.append("	private ").append(this
					.convert2JavaType(this.dto.getList().get(i).getDataType()));
			sb.append(" " + StringFormatUtil.formatFirstWorldToLower(
	...
	private String getGetterString(String columnName, String dataType) {
		...
		sb.append("		return this."
				+ StringFormatUtil.formatFirstWorldToLower(columnName) + ";\n");
		sb.append("	}\n \n");
		return sb.toString();
	}
