...
public class EdiquerylogPo implements IEdiquerylogPo {
	...
	private String hwb;
	private String ws;
	private java.sql.Timestamp querystarttime;
	private java.sql.Timestamp queryendtime;
	...
	@Override
	public java.sql.Timestamp getQuerystarttime() {
		return this.querystarttime;
	}
 
	@Override
	public void setQuerystarttime(final java.sql.Timestamp querystarttime) {
		this.querystarttime = querystarttime; 
	}
 
	@Override
	public java.sql.Timestamp getQueryendtime() {
		return this.queryendtime;
	}
 
	@Override
	public void setQueryendtime(final java.sql.Timestamp queryendtime) {
