...
public class T5201backupPo implements IT5201backupPo {
	...
	@Override
	public String getWarehouseban() {
		return this.warehouseban;
	}
 
	@Override
	public void setWarehouseban(final String warehouseban) {
		this.warehouseban = warehouseban; 
	}
