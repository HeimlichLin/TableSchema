...
public class WorkexphwbPo implements IWorkexphwbPo {
	...
	public enum COLUMNS {
		...
		EXPREOWNER("null"), //
		CFF("null"), //
		OCLEARANCETYPE("原通關方式"), //
		OCTRCVDATE("原通關方式接收時間"), //
		CTLASTUPDATE("通關方式最後異動時間") //
		;
	...
	private String lastdeclno;
	private String lastdecltype;
	private String workarea;
	private String expreowner;
	private String cff;
	private String oclearancetype;
	private java.sql.Timestamp octrcvdate;
	private java.sql.Timestamp ctlastupdate;
	...
	@Override
	public String getLastdeclno() {
		return this.lastdeclno;
	}
 
	@Override
	public void setLastdeclno(final String lastdeclno) {
		this.lastdeclno = lastdeclno; 
	}
 
	@Override
	public String getLastdecltype() {
		return this.lastdecltype;
	}
 
	@Override
	public void setLastdecltype(final String lastdecltype) {
		this.lastdecltype = lastdecltype; 
	}
	...
	@Override
	public String getExpreowner() {
		return this.expreowner;
	}
 
	@Override
	public void setExpreowner(final String expreowner) {
		this.expreowner = expreowner; 
	}
	...
	@Override
	public void setCff(final String cff) {
		this.cff = cff; 
	}
 
	@Override
	public String getOclearancetype() {
		return this.oclearancetype;
	}
 
	@Override
	public void setOclearancetype(final String oclearancetype) {
		this.oclearancetype = oclearancetype; 
	}
 
	@Override
	public java.sql.Timestamp getOctrcvdate() {
		return this.octrcvdate;
	}
 
	@Override
	public void setOctrcvdate(final java.sql.Timestamp octrcvdate) {
		this.octrcvdate = octrcvdate; 
	}
 
	@Override
	public java.sql.Timestamp getCtlastupdate() {
		return this.ctlastupdate;
	}
 
	@Override
	public void setCtlastupdate(final java.sql.Timestamp ctlastupdate) {
		this.ctlastupdate = ctlastupdate; 
	}
