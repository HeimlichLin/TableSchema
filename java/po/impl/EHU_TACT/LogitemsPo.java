...
public class LogitemsPo implements ILogitemsPo {
	...
	@Override
	public String getItemsDeclno() {
		return this.itemsDeclno;
	}
 
	@Override
	public void setItemsDeclno(final String itemsDeclno) {
		this.itemsDeclno = itemsDeclno; 
	}
