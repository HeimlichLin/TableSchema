...
"), //
		SONO("艙單號碼/裝貨單號碼
"), //
		CARRIERCODE("運輸業者/代理行代碼
"), //
		CONSOLIDATORCODE("承攬運送業者代碼
") //
		;
	...
	public String getConsolidatorcode() {
		return this.consolidatorcode;
	}
 
	@Override
	public void setConsolidatorcode(final String consolidatorcode) {
		this.consolidatorcode = consolidatorcode; 
	}
