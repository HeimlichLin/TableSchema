...
public interface ITv02imphwbPo {
	...
	void setChtax(final BigDecimal chtax);
	...
	String getConvereyid();
 
	void setConvereyid(final String convereyid);
	...
	String getCancelgcoreason();
 
	void setCancelgcoreason(final String cancelgcoreason);
 
	java.sql.Timestamp getCancelgcodate();
 
	void setCancelgcodate(final java.sql.Timestamp cancelgcodate);
