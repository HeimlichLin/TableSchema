...
public interface IWorkexphwbPo {
	...
	java.sql.Timestamp getCancelrelease();
 
	void setCancelrelease(final java.sql.Timestamp cancelrelease);
 
	String getManuclearancetype();
 
	void setManuclearancetype(final String manuclearancetype);
	...
	BigDecimal getDutypayment();
 
	void setDutypayment(final BigDecimal dutypayment);
	...
	java.sql.Timestamp getGcidate2();
 
	void setGcidate2(final java.sql.Timestamp gcidate2);
	...
	java.sql.Timestamp getGcodate2();
 
	void setGcodate2(final java.sql.Timestamp gcodate2);
	...
	BigDecimal getCancelgco();
 
	void setCancelgco(final BigDecimal cancelgco);
	...
	void setHoldreason(final String holdreason);
	...
	java.sql.Timestamp getPrintduty();
 
	void setPrintduty(final java.sql.Timestamp printduty);
 
	String getPrintuser();
 
	void setPrintuser(final String printuser);
 
	BigDecimal getPrintsn();
 
	void setPrintsn(final BigDecimal printsn);
 
	java.sql.Timestamp getGcilock();
 
	void setGcilock(final java.sql.Timestamp gcilock);
 
	String getLockuser();
 
	void setLockuser(final String lockuser);
 
	String getLastdeclno();
 
	void setLastdeclno(final String lastdeclno);
 
	String getLastdecltype();
 
	void setLastdecltype(final String lastdecltype);
 
	String getWorkarea();
 
	void setWorkarea(final String workarea);
 
	String getExpreowner();
 
	void setExpreowner(final String expreowner);
 
	String getCff();
 
	void setCff(final String cff);
 
	String getOclearancetype();
 
	void setOclearancetype(final String oclearancetype);
 
	java.sql.Timestamp getOctrcvdate();
 
	void setOctrcvdate(final java.sql.Timestamp octrcvdate);
 
	java.sql.Timestamp getCtlastupdate();
 
	void setCtlastupdate(final java.sql.Timestamp ctlastupdate);
