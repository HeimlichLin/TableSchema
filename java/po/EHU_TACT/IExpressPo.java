...
public interface IExpressPo {
	...
	void setStartdate(final java.sql.Timestamp startdate);
 
	java.sql.Timestamp getEnddate();
 
	void setEnddate(final java.sql.Timestamp enddate);
 
	String getImpaccount();
 
	void setImpaccount(final String impaccount);
 
	String getExpressarea();
 
	void setExpressarea(final String expressarea);
 
	String getPrttal();
 
	void setPrttal(final String prttal);
 
	String getMailname1();
 
	void setMailname1(final String mailname1);
 
	String getMailname2();
 
	void setMailname2(final String mailname2);
 
	String getMailadd1();
 
	void setMailadd1(final String mailadd1);
 
	String getMailadd2();
 
	void setMailadd2(final String mailadd2);
 
	String getDiffduty();
 
	void setDiffduty(final String diffduty);
