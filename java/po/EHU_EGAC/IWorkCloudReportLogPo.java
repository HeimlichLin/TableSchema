...
public interface IWorkCloudReportLogPo {
	...
	String getPrnlablestime();
 
	void setPrnlablestime(final String prnlablestime);
 
	String getPrnlableetime();
 
	void setPrnlableetime(final String prnlableetime);
 
	String getPrnchkcomstime();
 
	void setPrnchkcomstime(final String prnchkcomstime);
 
	String getPrnchkcometime();
 
	void setPrnchkcometime(final String prnchkcometime);
