...
public class EdiquerylogDAOImpl extends GeneralDAOImpl<EdiquerylogPo> implements EdiquerylogDAO { 
	...
	protected static final MapConverter<EdiquerylogPo> CONVERTER = new MapConverter<EdiquerylogPo>() { 
		...
		public EdiquerylogPo convert(final DataObject dataObject) { 
			...
			ediquerylogPo.setQuerystarttime(TimestampUtils.of(dataObject.getValue(EdiquerylogPo.COLUMNS.QUERYSTARTTIME.name()))); 
			ediquerylogPo.setQueryendtime(TimestampUtils.of(dataObject.getValue(EdiquerylogPo.COLUMNS.QUERYENDTIME.name()))); 
		...
		public DataObject toDataObject(final EdiquerylogPo ediquerylogPo) { 
			...
			dataObject.setValue(EdiquerylogPo.COLUMNS.QUERYSTARTTIME.name(), ediquerylogPo.getQuerystarttime()); 
			dataObject.setValue(EdiquerylogPo.COLUMNS.QUERYENDTIME.name(), ediquerylogPo.getQueryendtime()); 
			return dataObject; 
		} 
