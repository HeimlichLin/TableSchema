...
public class WorkCloudReportLogDAOImpl extends GeneralDAOImpl<WorkCloudReportLogPo> implements WorkCloudReportLogDAO { 
	...
	protected static final MapConverter<WorkCloudReportLogPo> CONVERTER = new MapConverter<WorkCloudReportLogPo>() { 
		...
		public WorkCloudReportLogPo convert(final DataObject dataObject) { 
			...
			workCloudReportLogPo.setPrnlablestime(dataObject.getString(WorkCloudReportLogPo.COLUMNS.PRNLABLESTIME.name())); 
			workCloudReportLogPo.setPrnlableetime(dataObject.getString(WorkCloudReportLogPo.COLUMNS.PRNLABLEETIME.name())); 
			workCloudReportLogPo.setPrnchkcomstime(dataObject.getString(WorkCloudReportLogPo.COLUMNS.PRNCHKCOMSTIME.name())); 
			workCloudReportLogPo.setPrnchkcometime(dataObject.getString(WorkCloudReportLogPo.COLUMNS.PRNCHKCOMETIME.name())); 
		...
		public DataObject toDataObject(final WorkCloudReportLogPo workCloudReportLogPo) { 
			...
			dataObject.setValue(WorkCloudReportLogPo.COLUMNS.PRNLABLESTIME.name(), workCloudReportLogPo.getPrnlablestime()); 
			dataObject.setValue(WorkCloudReportLogPo.COLUMNS.PRNLABLEETIME.name(), workCloudReportLogPo.getPrnlableetime()); 
			dataObject.setValue(WorkCloudReportLogPo.COLUMNS.PRNCHKCOMSTIME.name(), workCloudReportLogPo.getPrnchkcomstime()); 
			dataObject.setValue(WorkCloudReportLogPo.COLUMNS.PRNCHKCOMETIME.name(), workCloudReportLogPo.getPrnchkcometime()); 
			return dataObject; 
		} 
