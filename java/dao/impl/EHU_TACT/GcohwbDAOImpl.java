...
public class GcohwbDAOImpl extends GeneralDAOImpl<GcohwbPo> implements GcohwbDAO { 
	...
	protected static final MapConverter<GcohwbPo> CONVERTER = new MapConverter<GcohwbPo>() { 
		...
		public GcohwbPo convert(final DataObject dataObject) { 
			...
			gcohwbPo.setGcilock(TimestampUtils.of(dataObject.getValue(GcohwbPo.COLUMNS.GCILOCK.name()))); 
			gcohwbPo.setLockuser(dataObject.getString(GcohwbPo.COLUMNS.LOCKUSER.name())); 
			gcohwbPo.setLastdeclno(dataObject.getString(GcohwbPo.COLUMNS.LASTDECLNO.name())); 
			gcohwbPo.setLastdecltype(dataObject.getString(GcohwbPo.COLUMNS.LASTDECLTYPE.name())); 
			gcohwbPo.setWorkarea(dataObject.getString(GcohwbPo.COLUMNS.WORKAREA.name())); 
			gcohwbPo.setExpreowner(dataObject.getString(GcohwbPo.COLUMNS.EXPREOWNER.name())); 
			gcohwbPo.setCff(dataObject.getString(GcohwbPo.COLUMNS.CFF.name())); 
			gcohwbPo.setOclearancetype(dataObject.getString(GcohwbPo.COLUMNS.OCLEARANCETYPE.name())); 
			gcohwbPo.setOctrcvdate(TimestampUtils.of(dataObject.getValue(GcohwbPo.COLUMNS.OCTRCVDATE.name()))); 
			gcohwbPo.setCtlastupdate(TimestampUtils.of(dataObject.getValue(GcohwbPo.COLUMNS.CTLASTUPDATE.name()))); 
			return gcohwbPo; 
		} 
		...
		public DataObject toDataObject(final GcohwbPo gcohwbPo) { 
			...
			dataObject.setValue(GcohwbPo.COLUMNS.GCILOCK.name(), gcohwbPo.getGcilock()); 
			dataObject.setValue(GcohwbPo.COLUMNS.LOCKUSER.name(), gcohwbPo.getLockuser()); 
			dataObject.setValue(GcohwbPo.COLUMNS.LASTDECLNO.name(), gcohwbPo.getLastdeclno()); 
			dataObject.setValue(GcohwbPo.COLUMNS.LASTDECLTYPE.name(), gcohwbPo.getLastdecltype()); 
			dataObject.setValue(GcohwbPo.COLUMNS.WORKAREA.name(), gcohwbPo.getWorkarea()); 
			dataObject.setValue(GcohwbPo.COLUMNS.EXPREOWNER.name(), gcohwbPo.getExpreowner()); 
			dataObject.setValue(GcohwbPo.COLUMNS.CFF.name(), gcohwbPo.getCff()); 
			dataObject.setValue(GcohwbPo.COLUMNS.OCLEARANCETYPE.name(), gcohwbPo.getOclearancetype()); 
			dataObject.setValue(GcohwbPo.COLUMNS.OCTRCVDATE.name(), gcohwbPo.getOctrcvdate()); 
			dataObject.setValue(GcohwbPo.COLUMNS.CTLASTUPDATE.name(), gcohwbPo.getCtlastupdate()); 
			return dataObject; 
		} 
