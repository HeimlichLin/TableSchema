...
public class WorkexpcloudhwbDAOImpl extends GeneralDAOImpl<WorkexpcloudhwbPo> implements WorkexpcloudhwbDAO { 
	...
	protected static final MapConverter<WorkexpcloudhwbPo> CONVERTER = new MapConverter<WorkexpcloudhwbPo>() { 
		...
		public WorkexpcloudhwbPo convert(final DataObject dataObject) { 
			...
			workexpcloudhwbPo.setLastdeclno(dataObject.getString(WorkexpcloudhwbPo.COLUMNS.LASTDECLNO.name())); 
			workexpcloudhwbPo.setLastdecltype(dataObject.getString(WorkexpcloudhwbPo.COLUMNS.LASTDECLTYPE.name())); 
			workexpcloudhwbPo.setWorkarea(dataObject.getString(WorkexpcloudhwbPo.COLUMNS.WORKAREA.name())); 
			workexpcloudhwbPo.setExpreowner(dataObject.getString(WorkexpcloudhwbPo.COLUMNS.EXPREOWNER.name())); 
		...
		public DataObject toDataObject(final WorkexpcloudhwbPo workexpcloudhwbPo) { 
			...
			dataObject.setValue(WorkexpcloudhwbPo.COLUMNS.LASTDECLNO.name(), workexpcloudhwbPo.getLastdeclno()); 
			dataObject.setValue(WorkexpcloudhwbPo.COLUMNS.LASTDECLTYPE.name(), workexpcloudhwbPo.getLastdecltype()); 
			dataObject.setValue(WorkexpcloudhwbPo.COLUMNS.WORKAREA.name(), workexpcloudhwbPo.getWorkarea()); 
			dataObject.setValue(WorkexpcloudhwbPo.COLUMNS.EXPREOWNER.name(), workexpcloudhwbPo.getExpreowner()); 
