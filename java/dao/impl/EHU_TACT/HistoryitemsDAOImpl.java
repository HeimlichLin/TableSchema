...
public class HistoryitemsDAOImpl extends GeneralDAOImpl<HistoryitemsPo> implements HistoryitemsDAO { 
	...
	protected static final MapConverter<HistoryitemsPo> CONVERTER = new MapConverter<HistoryitemsPo>() { 
		...
		public HistoryitemsPo convert(final DataObject dataObject) { 
			...
			historyitemsPo.setDeclno(dataObject.getString(HistoryitemsPo.COLUMNS.DECLNO.name())); 
			historyitemsPo.setFlightdest(dataObject.getString(HistoryitemsPo.COLUMNS.FLIGHTDEST.name())); 
			historyitemsPo.setWorkarea(dataObject.getString(HistoryitemsPo.COLUMNS.WORKAREA.name())); 
			historyitemsPo.setUldflag(TimestampUtils.of(dataObject.getValue(HistoryitemsPo.COLUMNS.ULDFLAG.name()))); 
			historyitemsPo.setCustomsid(dataObject.getString(HistoryitemsPo.COLUMNS.CUSTOMSID.name())); 
			historyitemsPo.setOcustomsid(dataObject.getString(HistoryitemsPo.COLUMNS.OCUSTOMSID.name())); 
		...
		public DataObject toDataObject(final HistoryitemsPo historyitemsPo) { 
			...
			dataObject.setValue(HistoryitemsPo.COLUMNS.DECLNO.name(), historyitemsPo.getDeclno()); 
			dataObject.setValue(HistoryitemsPo.COLUMNS.FLIGHTDEST.name(), historyitemsPo.getFlightdest()); 
			dataObject.setValue(HistoryitemsPo.COLUMNS.WORKAREA.name(), historyitemsPo.getWorkarea()); 
			dataObject.setValue(HistoryitemsPo.COLUMNS.ULDFLAG.name(), historyitemsPo.getUldflag()); 
			dataObject.setValue(HistoryitemsPo.COLUMNS.CUSTOMSID.name(), historyitemsPo.getCustomsid()); 
			dataObject.setValue(HistoryitemsPo.COLUMNS.OCUSTOMSID.name(), historyitemsPo.getOcustomsid()); 
			return dataObject; 
		} 
