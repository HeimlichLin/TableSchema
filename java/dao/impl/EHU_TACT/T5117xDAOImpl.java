...
public class T5117xDAOImpl extends GeneralDAOImpl<T5117xPo> implements T5117xDAO { 
	...
	protected static final MapConverter<T5117xPo> CONVERTER = new MapConverter<T5117xPo>() { 
		...
		public T5117xPo convert(final DataObject dataObject) { 
			...
			t5117xPo.setIe(dataObject.getString(T5117xPo.COLUMNS.IE.name())); 
			t5117xPo.setWarehouseno(dataObject.getString(T5117xPo.COLUMNS.WAREHOUSENO.name())); 
			return t5117xPo; 
		} 
		...
		public DataObject toDataObject(final T5117xPo t5117xPo) { 
			...
			dataObject.setValue(T5117xPo.COLUMNS.IE.name(), t5117xPo.getIe()); 
			dataObject.setValue(T5117xPo.COLUMNS.WAREHOUSENO.name(), t5117xPo.getWarehouseno()); 
			return dataObject; 
		} 
