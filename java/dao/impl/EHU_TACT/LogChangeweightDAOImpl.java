...
public class LogChangeweightDAOImpl extends GeneralDAOImpl<LogChangeweightPo> implements LogChangeweightDAO { 
	...
	protected static final MapConverter<LogChangeweightPo> CONVERTER = new MapConverter<LogChangeweightPo>() { 
		...
		public LogChangeweightPo convert(final DataObject dataObject) { 
			...
			logChangeweightPo.setDeclno(dataObject.getString(LogChangeweightPo.COLUMNS.DECLNO.name())); 
			logChangeweightPo.setBagno(dataObject.getString(LogChangeweightPo.COLUMNS.BAGNO.name())); 
			logChangeweightPo.setWorkarea(dataObject.getString(LogChangeweightPo.COLUMNS.WORKAREA.name())); 
			logChangeweightPo.setOcustomsid(dataObject.getString(LogChangeweightPo.COLUMNS.OCUSTOMSID.name())); 
		...
		public DataObject toDataObject(final LogChangeweightPo logChangeweightPo) { 
			...
			dataObject.setValue(LogChangeweightPo.COLUMNS.DECLNO.name(), logChangeweightPo.getDeclno()); 
			dataObject.setValue(LogChangeweightPo.COLUMNS.BAGNO.name(), logChangeweightPo.getBagno()); 
			dataObject.setValue(LogChangeweightPo.COLUMNS.WORKAREA.name(), logChangeweightPo.getWorkarea()); 
			dataObject.setValue(LogChangeweightPo.COLUMNS.OCUSTOMSID.name(), logChangeweightPo.getOcustomsid()); 
			return dataObject; 
		} 
