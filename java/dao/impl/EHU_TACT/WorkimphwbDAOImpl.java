...
public class WorkimphwbDAOImpl extends GeneralDAOImpl<WorkimphwbPo> implements WorkimphwbDAO { 
	...
	protected static final MapConverter<WorkimphwbPo> CONVERTER = new MapConverter<WorkimphwbPo>() { 
		...
		public WorkimphwbPo convert(final DataObject dataObject) { 
			...
			workimphwbPo.setGcilock(TimestampUtils.of(dataObject.getValue(WorkimphwbPo.COLUMNS.GCILOCK.name()))); 
			workimphwbPo.setLockuser(dataObject.getString(WorkimphwbPo.COLUMNS.LOCKUSER.name())); 
			workimphwbPo.setLastdeclno(dataObject.getString(WorkimphwbPo.COLUMNS.LASTDECLNO.name())); 
			workimphwbPo.setLastdecltype(dataObject.getString(WorkimphwbPo.COLUMNS.LASTDECLTYPE.name())); 
			workimphwbPo.setWorkarea(dataObject.getString(WorkimphwbPo.COLUMNS.WORKAREA.name())); 
			workimphwbPo.setExpreowner(dataObject.getString(WorkimphwbPo.COLUMNS.EXPREOWNER.name())); 
			workimphwbPo.setCff(dataObject.getString(WorkimphwbPo.COLUMNS.CFF.name())); 
			workimphwbPo.setOclearancetype(dataObject.getString(WorkimphwbPo.COLUMNS.OCLEARANCETYPE.name())); 
			workimphwbPo.setOctrcvdate(TimestampUtils.of(dataObject.getValue(WorkimphwbPo.COLUMNS.OCTRCVDATE.name()))); 
			workimphwbPo.setCtlastupdate(TimestampUtils.of(dataObject.getValue(WorkimphwbPo.COLUMNS.CTLASTUPDATE.name()))); 
			return workimphwbPo; 
		} 
		...
		public DataObject toDataObject(final WorkimphwbPo workimphwbPo) { 
			...
			dataObject.setValue(WorkimphwbPo.COLUMNS.GCILOCK.name(), workimphwbPo.getGcilock()); 
			dataObject.setValue(WorkimphwbPo.COLUMNS.LOCKUSER.name(), workimphwbPo.getLockuser()); 
			dataObject.setValue(WorkimphwbPo.COLUMNS.LASTDECLNO.name(), workimphwbPo.getLastdeclno()); 
			dataObject.setValue(WorkimphwbPo.COLUMNS.LASTDECLTYPE.name(), workimphwbPo.getLastdecltype()); 
			dataObject.setValue(WorkimphwbPo.COLUMNS.WORKAREA.name(), workimphwbPo.getWorkarea()); 
			dataObject.setValue(WorkimphwbPo.COLUMNS.EXPREOWNER.name(), workimphwbPo.getExpreowner()); 
			dataObject.setValue(WorkimphwbPo.COLUMNS.CFF.name(), workimphwbPo.getCff()); 
			dataObject.setValue(WorkimphwbPo.COLUMNS.OCLEARANCETYPE.name(), workimphwbPo.getOclearancetype()); 
			dataObject.setValue(WorkimphwbPo.COLUMNS.OCTRCVDATE.name(), workimphwbPo.getOctrcvdate()); 
			dataObject.setValue(WorkimphwbPo.COLUMNS.CTLASTUPDATE.name(), workimphwbPo.getCtlastupdate()); 
			return dataObject; 
		} 
