...
public class T5117xbackupDAOImpl extends GeneralDAOImpl<T5117xbackupPo> implements T5117xbackupDAO { 
	...
	protected static final MapConverter<T5117xbackupPo> CONVERTER = new MapConverter<T5117xbackupPo>() { 
		...
		public T5117xbackupPo convert(final DataObject dataObject) { 
			...
			t5117xbackupPo.setIe(dataObject.getString(T5117xbackupPo.COLUMNS.IE.name())); 
			t5117xbackupPo.setWarehouseno(dataObject.getString(T5117xbackupPo.COLUMNS.WAREHOUSENO.name())); 
		...
		public DataObject toDataObject(final T5117xbackupPo t5117xbackupPo) { 
			...
			dataObject.setValue(T5117xbackupPo.COLUMNS.IE.name(), t5117xbackupPo.getIe()); 
			dataObject.setValue(T5117xbackupPo.COLUMNS.WAREHOUSENO.name(), t5117xbackupPo.getWarehouseno()); 
			return dataObject; 
		} 
