...
public class T5108DAOImpl extends GeneralDAOImpl<T5108Po> implements T5108DAO { 
	...
	protected static final MapConverter<T5108Po> CONVERTER = new MapConverter<T5108Po>() { 
		...
		public T5108Po convert(final DataObject dataObject) { 
			...
			t5108Po.setImpMwb(dataObject.getString(T5108Po.COLUMNS.IMP_MWB.name())); 
			t5108Po.setImpHwb(dataObject.getString(T5108Po.COLUMNS.IMP_HWB.name())); 
			t5108Po.setTypecode(dataObject.getString(T5108Po.COLUMNS.TYPECODE.name())); 
			...
			t5108Po.setSono(dataObject.getString(T5108Po.COLUMNS.SONO.name())); 
			t5108Po.setVrno(dataObject.getString(T5108Po.COLUMNS.VRNO.name())); 
			...
			t5108Po.setSoqty(dataObject.getString(T5108Po.COLUMNS.SOQTY.name())); 
			t5108Po.setTotalcontainerqty(dataObject.getString(T5108Po.COLUMNS.TOTALCONTAINERQTY.name())); 
			t5108Po.setEmptycontainerqty(dataObject.getString(T5108Po.COLUMNS.EMPTYCONTAINERQTY.name())); 
			return t5108Po; 
		} 
		...
		public DataObject toDataObject(final T5108Po t5108Po) { 
			...
			dataObject.setValue(T5108Po.COLUMNS.IMP_MWB.name(), t5108Po.getImpMwb()); 
			dataObject.setValue(T5108Po.COLUMNS.IMP_HWB.name(), t5108Po.getImpHwb()); 
			dataObject.setValue(T5108Po.COLUMNS.TYPECODE.name(), t5108Po.getTypecode()); 
			...
			dataObject.setValue(T5108Po.COLUMNS.SONO.name(), t5108Po.getSono()); 
			dataObject.setValue(T5108Po.COLUMNS.VRNO.name(), t5108Po.getVrno()); 
			...
			dataObject.setValue(T5108Po.COLUMNS.SOQTY.name(), t5108Po.getSoqty()); 
			dataObject.setValue(T5108Po.COLUMNS.TOTALCONTAINERQTY.name(), t5108Po.getTotalcontainerqty()); 
			dataObject.setValue(T5108Po.COLUMNS.EMPTYCONTAINERQTY.name(), t5108Po.getEmptycontainerqty()); 
			return dataObject; 
		} 
