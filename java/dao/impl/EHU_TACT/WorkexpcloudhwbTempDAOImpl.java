...
public class WorkexpcloudhwbTempDAOImpl extends GeneralDAOImpl<WorkexpcloudhwbTempPo> implements WorkexpcloudhwbTempDAO { 
	...
	protected static final MapConverter<WorkexpcloudhwbTempPo> CONVERTER = new MapConverter<WorkexpcloudhwbTempPo>() { 
		...
		public WorkexpcloudhwbTempPo convert(final DataObject dataObject) { 
			...
			workexpcloudhwbTempPo.setLastdeclno(dataObject.getString(WorkexpcloudhwbTempPo.COLUMNS.LASTDECLNO.name())); 
			workexpcloudhwbTempPo.setLastdecltype(dataObject.getString(WorkexpcloudhwbTempPo.COLUMNS.LASTDECLTYPE.name())); 
			workexpcloudhwbTempPo.setWorkarea(dataObject.getString(WorkexpcloudhwbTempPo.COLUMNS.WORKAREA.name())); 
			workexpcloudhwbTempPo.setExpreowner(dataObject.getString(WorkexpcloudhwbTempPo.COLUMNS.EXPREOWNER.name())); 
		...
		public DataObject toDataObject(final WorkexpcloudhwbTempPo workexpcloudhwbTempPo) { 
			...
			dataObject.setValue(WorkexpcloudhwbTempPo.COLUMNS.LASTDECLNO.name(), workexpcloudhwbTempPo.getLastdeclno()); 
			dataObject.setValue(WorkexpcloudhwbTempPo.COLUMNS.LASTDECLTYPE.name(), workexpcloudhwbTempPo.getLastdecltype()); 
			dataObject.setValue(WorkexpcloudhwbTempPo.COLUMNS.WORKAREA.name(), workexpcloudhwbTempPo.getWorkarea()); 
			dataObject.setValue(WorkexpcloudhwbTempPo.COLUMNS.EXPREOWNER.name(), workexpcloudhwbTempPo.getExpreowner()); 
