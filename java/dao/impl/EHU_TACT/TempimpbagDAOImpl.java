...
public class TempimpbagDAOImpl extends GeneralDAOImpl<TempimpbagPo> implements TempimpbagDAO { 
	...
	protected static final MapConverter<TempimpbagPo> CONVERTER = new MapConverter<TempimpbagPo>() { 
		...
		public TempimpbagPo convert(final DataObject dataObject) { 
			...
			tempimpbagPo.setChargeuser(dataObject.getString(TempimpbagPo.COLUMNS.CHARGEUSER.name())); 
			tempimpbagPo.setExpressfee(BigDecimalUtils.formObj(dataObject.getValue(TempimpbagPo.COLUMNS.EXPRESSFEE.name()))); 
			tempimpbagPo.setAirlinefee(BigDecimalUtils.formObj(dataObject.getValue(TempimpbagPo.COLUMNS.AIRLINEFEE.name()))); 
			tempimpbagPo.setFlightno(dataObject.getString(TempimpbagPo.COLUMNS.FLIGHTNO.name())); 
			tempimpbagPo.setLastchargedate(TimestampUtils.of(dataObject.getValue(TempimpbagPo.COLUMNS.LASTCHARGEDATE.name()))); 
			tempimpbagPo.setWorkarea(dataObject.getString(TempimpbagPo.COLUMNS.WORKAREA.name())); 
			return tempimpbagPo; 
		} 
		...
		public DataObject toDataObject(final TempimpbagPo tempimpbagPo) { 
			...
			dataObject.setValue(TempimpbagPo.COLUMNS.CHARGEUSER.name(), tempimpbagPo.getChargeuser()); 
			dataObject.setValue(TempimpbagPo.COLUMNS.EXPRESSFEE.name(), tempimpbagPo.getExpressfee()); 
			dataObject.setValue(TempimpbagPo.COLUMNS.AIRLINEFEE.name(), tempimpbagPo.getAirlinefee()); 
			dataObject.setValue(TempimpbagPo.COLUMNS.FLIGHTNO.name(), tempimpbagPo.getFlightno()); 
			dataObject.setValue(TempimpbagPo.COLUMNS.LASTCHARGEDATE.name(), tempimpbagPo.getLastchargedate()); 
			dataObject.setValue(TempimpbagPo.COLUMNS.WORKAREA.name(), tempimpbagPo.getWorkarea()); 
			return dataObject; 
		} 
