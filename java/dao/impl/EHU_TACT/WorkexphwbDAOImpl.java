...
public class WorkexphwbDAOImpl extends GeneralDAOImpl<WorkexphwbPo> implements WorkexphwbDAO { 
	...
	protected static final MapConverter<WorkexphwbPo> CONVERTER = new MapConverter<WorkexphwbPo>() { 
		...
		public WorkexphwbPo convert(final DataObject dataObject) { 
			...
			workexphwbPo.setGcilock(TimestampUtils.of(dataObject.getValue(WorkexphwbPo.COLUMNS.GCILOCK.name()))); 
			workexphwbPo.setLockuser(dataObject.getString(WorkexphwbPo.COLUMNS.LOCKUSER.name())); 
			workexphwbPo.setLastdeclno(dataObject.getString(WorkexphwbPo.COLUMNS.LASTDECLNO.name())); 
			workexphwbPo.setLastdecltype(dataObject.getString(WorkexphwbPo.COLUMNS.LASTDECLTYPE.name())); 
			workexphwbPo.setWorkarea(dataObject.getString(WorkexphwbPo.COLUMNS.WORKAREA.name())); 
			workexphwbPo.setExpreowner(dataObject.getString(WorkexphwbPo.COLUMNS.EXPREOWNER.name())); 
			workexphwbPo.setCff(dataObject.getString(WorkexphwbPo.COLUMNS.CFF.name())); 
			workexphwbPo.setOclearancetype(dataObject.getString(WorkexphwbPo.COLUMNS.OCLEARANCETYPE.name())); 
			workexphwbPo.setOctrcvdate(TimestampUtils.of(dataObject.getValue(WorkexphwbPo.COLUMNS.OCTRCVDATE.name()))); 
			workexphwbPo.setCtlastupdate(TimestampUtils.of(dataObject.getValue(WorkexphwbPo.COLUMNS.CTLASTUPDATE.name()))); 
			return workexphwbPo; 
		} 
		...
		public DataObject toDataObject(final WorkexphwbPo workexphwbPo) { 
			...
			dataObject.setValue(WorkexphwbPo.COLUMNS.GCILOCK.name(), workexphwbPo.getGcilock()); 
			dataObject.setValue(WorkexphwbPo.COLUMNS.LOCKUSER.name(), workexphwbPo.getLockuser()); 
			dataObject.setValue(WorkexphwbPo.COLUMNS.LASTDECLNO.name(), workexphwbPo.getLastdeclno()); 
			dataObject.setValue(WorkexphwbPo.COLUMNS.LASTDECLTYPE.name(), workexphwbPo.getLastdecltype()); 
			dataObject.setValue(WorkexphwbPo.COLUMNS.WORKAREA.name(), workexphwbPo.getWorkarea()); 
			dataObject.setValue(WorkexphwbPo.COLUMNS.EXPREOWNER.name(), workexphwbPo.getExpreowner()); 
			dataObject.setValue(WorkexphwbPo.COLUMNS.CFF.name(), workexphwbPo.getCff()); 
			dataObject.setValue(WorkexphwbPo.COLUMNS.OCLEARANCETYPE.name(), workexphwbPo.getOclearancetype()); 
			dataObject.setValue(WorkexphwbPo.COLUMNS.OCTRCVDATE.name(), workexphwbPo.getOctrcvdate()); 
			dataObject.setValue(WorkexphwbPo.COLUMNS.CTLASTUPDATE.name(), workexphwbPo.getCtlastupdate()); 
			return dataObject; 
		} 
