...
public class T5116TempDAOImpl extends GeneralDAOImpl<T5116TempPo> implements T5116TempDAO { 
	...
	protected static final MapConverter<T5116TempPo> CONVERTER = new MapConverter<T5116TempPo>() { 
		...
		public T5116TempPo convert(final DataObject dataObject) { 
			...
			t5116TempPo.setTypecode(dataObject.getString(T5116TempPo.COLUMNS.TYPECODE.name())); 
			...
			t5116TempPo.setVrno(dataObject.getString(T5116TempPo.COLUMNS.VRNO.name())); 
		...
		public DataObject toDataObject(final T5116TempPo t5116TempPo) { 
			...
			dataObject.setValue(T5116TempPo.COLUMNS.TYPECODE.name(), t5116TempPo.getTypecode()); 
			...
			dataObject.setValue(T5116TempPo.COLUMNS.VRNO.name(), t5116TempPo.getVrno()); 
