...
public class T5201DAOImpl extends GeneralDAOImpl<T5201Po> implements T5201DAO { 
	...
	protected static final MapConverter<T5201Po> CONVERTER = new MapConverter<T5201Po>() { 
		...
		public T5201Po convert(final DataObject dataObject) { 
			...
			t5201Po.setTypecode(dataObject.getString(T5201Po.COLUMNS.TYPECODE.name())); 
			t5201Po.setWarehouseban(dataObject.getString(T5201Po.COLUMNS.WAREHOUSEBAN.name())); 
			t5201Po.setIdentitycode(dataObject.getString(T5201Po.COLUMNS.IDENTITYCODE.name())); 
			return t5201Po; 
		} 
		...
		public DataObject toDataObject(final T5201Po t5201Po) { 
			...
			dataObject.setValue(T5201Po.COLUMNS.TYPECODE.name(), t5201Po.getTypecode()); 
			dataObject.setValue(T5201Po.COLUMNS.WAREHOUSEBAN.name(), t5201Po.getWarehouseban()); 
			dataObject.setValue(T5201Po.COLUMNS.IDENTITYCODE.name(), t5201Po.getIdentitycode()); 
			return dataObject; 
		} 
