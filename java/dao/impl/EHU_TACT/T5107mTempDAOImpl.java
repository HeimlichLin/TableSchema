...
public class T5107mTempDAOImpl extends GeneralDAOImpl<T5107mTempPo> implements T5107mTempDAO { 
	...
	protected static final MapConverter<T5107mTempPo> CONVERTER = new MapConverter<T5107mTempPo>() { 
		...
		public T5107mTempPo convert(final DataObject dataObject) { 
			...
			t5107mTempPo.setPermitno10(dataObject.getString(T5107mTempPo.COLUMNS.PERMITNO10.name())); 
			...
			t5107mTempPo.setTypecode(dataObject.getString(T5107mTempPo.COLUMNS.TYPECODE.name())); 
			t5107mTempPo.setFlightno(dataObject.getString(T5107mTempPo.COLUMNS.FLIGHTNO.name())); 
			t5107mTempPo.setVrno(dataObject.getString(T5107mTempPo.COLUMNS.VRNO.name())); 
			t5107mTempPo.setSono(dataObject.getString(T5107mTempPo.COLUMNS.SONO.name())); 
			t5107mTempPo.setCarriercode(dataObject.getString(T5107mTempPo.COLUMNS.CARRIERCODE.name())); 
			t5107mTempPo.setConsolidatorcode(dataObject.getString(T5107mTempPo.COLUMNS.CONSOLIDATORCODE.name())); 
			return t5107mTempPo; 
		} 
		...
		public DataObject toDataObject(final T5107mTempPo t5107mTempPo) { 
			...
			dataObject.setValue(T5107mTempPo.COLUMNS.PERMITNO10.name(), t5107mTempPo.getPermitno10()); 
			...
			dataObject.setValue(T5107mTempPo.COLUMNS.TYPECODE.name(), t5107mTempPo.getTypecode()); 
			dataObject.setValue(T5107mTempPo.COLUMNS.FLIGHTNO.name(), t5107mTempPo.getFlightno()); 
			dataObject.setValue(T5107mTempPo.COLUMNS.VRNO.name(), t5107mTempPo.getVrno()); 
			dataObject.setValue(T5107mTempPo.COLUMNS.SONO.name(), t5107mTempPo.getSono()); 
			dataObject.setValue(T5107mTempPo.COLUMNS.CARRIERCODE.name(), t5107mTempPo.getCarriercode()); 
			dataObject.setValue(T5107mTempPo.COLUMNS.CONSOLIDATORCODE.name(), t5107mTempPo.getConsolidatorcode()); 
			return dataObject; 
		} 
