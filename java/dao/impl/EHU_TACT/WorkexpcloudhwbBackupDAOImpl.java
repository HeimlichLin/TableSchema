...
public class WorkexpcloudhwbBackupDAOImpl extends GeneralDAOImpl<WorkexpcloudhwbBackupPo> implements WorkexpcloudhwbBackupDAO { 
	...
	protected static final MapConverter<WorkexpcloudhwbBackupPo> CONVERTER = new MapConverter<WorkexpcloudhwbBackupPo>() { 
		...
		public WorkexpcloudhwbBackupPo convert(final DataObject dataObject) { 
			...
			workexpcloudhwbBackupPo.setLastdeclno(dataObject.getString(WorkexpcloudhwbBackupPo.COLUMNS.LASTDECLNO.name())); 
			workexpcloudhwbBackupPo.setLastdecltype(dataObject.getString(WorkexpcloudhwbBackupPo.COLUMNS.LASTDECLTYPE.name())); 
			workexpcloudhwbBackupPo.setWorkarea(dataObject.getString(WorkexpcloudhwbBackupPo.COLUMNS.WORKAREA.name())); 
			workexpcloudhwbBackupPo.setExpreowner(dataObject.getString(WorkexpcloudhwbBackupPo.COLUMNS.EXPREOWNER.name())); 
		...
		public DataObject toDataObject(final WorkexpcloudhwbBackupPo workexpcloudhwbBackupPo) { 
			...
			dataObject.setValue(WorkexpcloudhwbBackupPo.COLUMNS.LASTDECLNO.name(), workexpcloudhwbBackupPo.getLastdeclno()); 
			dataObject.setValue(WorkexpcloudhwbBackupPo.COLUMNS.LASTDECLTYPE.name(), workexpcloudhwbBackupPo.getLastdecltype()); 
			dataObject.setValue(WorkexpcloudhwbBackupPo.COLUMNS.WORKAREA.name(), workexpcloudhwbBackupPo.getWorkarea()); 
			dataObject.setValue(WorkexpcloudhwbBackupPo.COLUMNS.EXPREOWNER.name(), workexpcloudhwbBackupPo.getExpreowner()); 
