...
public class HistoryhwbDAOImpl extends GeneralDAOImpl<HistoryhwbPo> implements HistoryhwbDAO { 
	...
	protected static final MapConverter<HistoryhwbPo> CONVERTER = new MapConverter<HistoryhwbPo>() { 
		...
		public HistoryhwbPo convert(final DataObject dataObject) { 
			...
			historyhwbPo.setGcilock(TimestampUtils.of(dataObject.getValue(HistoryhwbPo.COLUMNS.GCILOCK.name()))); 
			historyhwbPo.setLockuser(dataObject.getString(HistoryhwbPo.COLUMNS.LOCKUSER.name())); 
			historyhwbPo.setLastdeclno(dataObject.getString(HistoryhwbPo.COLUMNS.LASTDECLNO.name())); 
			historyhwbPo.setLastdecltype(dataObject.getString(HistoryhwbPo.COLUMNS.LASTDECLTYPE.name())); 
			historyhwbPo.setWorkarea(dataObject.getString(HistoryhwbPo.COLUMNS.WORKAREA.name())); 
			historyhwbPo.setExpreowner(dataObject.getString(HistoryhwbPo.COLUMNS.EXPREOWNER.name())); 
			historyhwbPo.setCff(dataObject.getString(HistoryhwbPo.COLUMNS.CFF.name())); 
			return historyhwbPo; 
		} 
		...
		public DataObject toDataObject(final HistoryhwbPo historyhwbPo) { 
			...
			dataObject.setValue(HistoryhwbPo.COLUMNS.GCILOCK.name(), historyhwbPo.getGcilock()); 
			dataObject.setValue(HistoryhwbPo.COLUMNS.LOCKUSER.name(), historyhwbPo.getLockuser()); 
			dataObject.setValue(HistoryhwbPo.COLUMNS.LASTDECLNO.name(), historyhwbPo.getLastdeclno()); 
			dataObject.setValue(HistoryhwbPo.COLUMNS.LASTDECLTYPE.name(), historyhwbPo.getLastdecltype()); 
			dataObject.setValue(HistoryhwbPo.COLUMNS.WORKAREA.name(), historyhwbPo.getWorkarea()); 
			dataObject.setValue(HistoryhwbPo.COLUMNS.EXPREOWNER.name(), historyhwbPo.getExpreowner()); 
			dataObject.setValue(HistoryhwbPo.COLUMNS.CFF.name(), historyhwbPo.getCff()); 
			return dataObject; 
		} 
