...
public class TempexphwbDAOImpl extends GeneralDAOImpl<TempexphwbPo> implements TempexphwbDAO { 
	...
	protected static final MapConverter<TempexphwbPo> CONVERTER = new MapConverter<TempexphwbPo>() { 
		...
		public TempexphwbPo convert(final DataObject dataObject) { 
			...
			tempexphwbPo.setGcilock(TimestampUtils.of(dataObject.getValue(TempexphwbPo.COLUMNS.GCILOCK.name()))); 
			tempexphwbPo.setLockuser(dataObject.getString(TempexphwbPo.COLUMNS.LOCKUSER.name())); 
			tempexphwbPo.setLastdeclno(dataObject.getString(TempexphwbPo.COLUMNS.LASTDECLNO.name())); 
			tempexphwbPo.setLastdecltype(dataObject.getString(TempexphwbPo.COLUMNS.LASTDECLTYPE.name())); 
			tempexphwbPo.setWorkarea(dataObject.getString(TempexphwbPo.COLUMNS.WORKAREA.name())); 
			tempexphwbPo.setExpreowner(dataObject.getString(TempexphwbPo.COLUMNS.EXPREOWNER.name())); 
			tempexphwbPo.setCff(dataObject.getString(TempexphwbPo.COLUMNS.CFF.name())); 
			tempexphwbPo.setOclearancetype(dataObject.getString(TempexphwbPo.COLUMNS.OCLEARANCETYPE.name())); 
			tempexphwbPo.setOctrcvdate(TimestampUtils.of(dataObject.getValue(TempexphwbPo.COLUMNS.OCTRCVDATE.name()))); 
			tempexphwbPo.setCtlastupdate(TimestampUtils.of(dataObject.getValue(TempexphwbPo.COLUMNS.CTLASTUPDATE.name()))); 
			return tempexphwbPo; 
		} 
		...
		public DataObject toDataObject(final TempexphwbPo tempexphwbPo) { 
			...
			dataObject.setValue(TempexphwbPo.COLUMNS.GCILOCK.name(), tempexphwbPo.getGcilock()); 
			dataObject.setValue(TempexphwbPo.COLUMNS.LOCKUSER.name(), tempexphwbPo.getLockuser()); 
			dataObject.setValue(TempexphwbPo.COLUMNS.LASTDECLNO.name(), tempexphwbPo.getLastdeclno()); 
			dataObject.setValue(TempexphwbPo.COLUMNS.LASTDECLTYPE.name(), tempexphwbPo.getLastdecltype()); 
			dataObject.setValue(TempexphwbPo.COLUMNS.WORKAREA.name(), tempexphwbPo.getWorkarea()); 
			dataObject.setValue(TempexphwbPo.COLUMNS.EXPREOWNER.name(), tempexphwbPo.getExpreowner()); 
			dataObject.setValue(TempexphwbPo.COLUMNS.CFF.name(), tempexphwbPo.getCff()); 
			dataObject.setValue(TempexphwbPo.COLUMNS.OCLEARANCETYPE.name(), tempexphwbPo.getOclearancetype()); 
			dataObject.setValue(TempexphwbPo.COLUMNS.OCTRCVDATE.name(), tempexphwbPo.getOctrcvdate()); 
			dataObject.setValue(TempexphwbPo.COLUMNS.CTLASTUPDATE.name(), tempexphwbPo.getCtlastupdate()); 
			return dataObject; 
		} 
