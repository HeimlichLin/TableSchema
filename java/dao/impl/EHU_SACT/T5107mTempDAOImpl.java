...
public class T5107mTempDAOImpl extends GeneralDAOImpl<T5107mTempPo> implements T5107mTempDAO { 
	...
	protected static final MapConverter<T5107mTempPo> CONVERTER = new MapConverter<T5107mTempPo>() { 
		...
		public T5107mTempPo convert(final DataObject dataObject) { 
			...
			t5107mTempPo.setImportdatetime(dataObject.getString(T5107mTempPo.COLUMNS.IMPORTDATETIME.name())); 
			...
			t5107mTempPo.setBaghwb(dataObject.getString(T5107mTempPo.COLUMNS.BAGHWB.name())); 
			return t5107mTempPo; 
		} 
		...
		public DataObject toDataObject(final T5107mTempPo t5107mTempPo) { 
			...
			dataObject.setValue(T5107mTempPo.COLUMNS.IMPORTDATETIME.name(), t5107mTempPo.getImportdatetime()); 
			...
			dataObject.setValue(T5107mTempPo.COLUMNS.BAGHWB.name(), t5107mTempPo.getBaghwb()); 
			return dataObject; 
		} 
