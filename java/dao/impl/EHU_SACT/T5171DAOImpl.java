...
public class T5171DAOImpl extends GeneralDAOImpl<T5171Po> implements T5171DAO { 
	...
	protected static final MapConverter<T5171Po> CONVERTER = new MapConverter<T5171Po>() { 
		...
		public T5171Po convert(final DataObject dataObject) { 
			...
			t5171Po.setDeclno(dataObject.getString(T5171Po.COLUMNS.DECLNO.name())); 
			t5171Po.setBagno(dataObject.getString(T5171Po.COLUMNS.BAGNO.name())); 
			t5171Po.setPkghwb(dataObject.getString(T5171Po.COLUMNS.PKGHWB.name())); 
			t5171Po.setPkghwbqty(dataObject.getString(T5171Po.COLUMNS.PKGHWBQTY.name())); 
			t5171Po.setPkgbagweight(dataObject.getString(T5171Po.COLUMNS.PKGBAGWEIGHT.name())); 
			t5171Po.setPkgbagpce(dataObject.getString(T5171Po.COLUMNS.PKGBAGPCE.name())); 
			t5171Po.setPkgbagno(dataObject.getString(T5171Po.COLUMNS.PKGBAGNO.name())); 
			t5171Po.setSenddate(dataObject.getString(T5171Po.COLUMNS.SENDDATE.name())); 
			return t5171Po; 
		} 
		...
		public DataObject toDataObject(final T5171Po t5171Po) { 
			...
			dataObject.setValue(T5171Po.COLUMNS.DECLNO.name(), t5171Po.getDeclno()); 
			dataObject.setValue(T5171Po.COLUMNS.BAGNO.name(), t5171Po.getBagno()); 
			dataObject.setValue(T5171Po.COLUMNS.PKGHWB.name(), t5171Po.getPkghwb()); 
			dataObject.setValue(T5171Po.COLUMNS.PKGHWBQTY.name(), t5171Po.getPkghwbqty()); 
			dataObject.setValue(T5171Po.COLUMNS.PKGBAGWEIGHT.name(), t5171Po.getPkgbagweight()); 
			dataObject.setValue(T5171Po.COLUMNS.PKGBAGPCE.name(), t5171Po.getPkgbagpce()); 
			dataObject.setValue(T5171Po.COLUMNS.PKGBAGNO.name(), t5171Po.getPkgbagno()); 
			dataObject.setValue(T5171Po.COLUMNS.SENDDATE.name(), t5171Po.getSenddate()); 
			return dataObject; 
		} 
