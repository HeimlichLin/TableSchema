...
public class ExpressDAOImpl extends GeneralDAOImpl<ExpressPo> implements ExpressDAO { 
	...
	protected static final MapConverter<ExpressPo> CONVERTER = new MapConverter<ExpressPo>() { 
		...
		public ExpressPo convert(final DataObject dataObject) { 
			...
			expressPo.setExpiredate(dataObject.getString(ExpressPo.COLUMNS.EXPIREDATE.name())); 
			expressPo.setStartdate(dataObject.getString(ExpressPo.COLUMNS.STARTDATE.name())); 
			expressPo.setChkIo(dataObject.getString(ExpressPo.COLUMNS.CHK_IO.name())); 
			return expressPo; 
		} 
		...
		public DataObject toDataObject(final ExpressPo expressPo) { 
			...
			dataObject.setValue(ExpressPo.COLUMNS.EXPIREDATE.name(), expressPo.getExpiredate()); 
			dataObject.setValue(ExpressPo.COLUMNS.STARTDATE.name(), expressPo.getStartdate()); 
			dataObject.setValue(ExpressPo.COLUMNS.CHK_IO.name(), expressPo.getChkIo()); 
			return dataObject; 
		} 
