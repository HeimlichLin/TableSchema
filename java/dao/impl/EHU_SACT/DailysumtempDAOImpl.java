...
public class DailysumtempDAOImpl extends GeneralDAOImpl<DailysumtempPo> implements DailysumtempDAO { 
	...
	protected static final MapConverter<DailysumtempPo> CONVERTER = new MapConverter<DailysumtempPo>() { 
		...
		public DailysumtempPo convert(final DataObject dataObject) { 
			...
			dailysumtempPo.setExportdiscount(BigDecimalUtils.formObj(dataObject.getValue(DailysumtempPo.COLUMNS.EXPORTDISCOUNT.name()))); 
			...
			dailysumtempPo.setImportdiscount(BigDecimalUtils.formObj(dataObject.getValue(DailysumtempPo.COLUMNS.IMPORTDISCOUNT.name()))); 
		...
		public DataObject toDataObject(final DailysumtempPo dailysumtempPo) { 
			...
			dataObject.setValue(DailysumtempPo.COLUMNS.EXPORTDISCOUNT.name(), dailysumtempPo.getExportdiscount()); 
			...
			dataObject.setValue(DailysumtempPo.COLUMNS.IMPORTDISCOUNT.name(), dailysumtempPo.getImportdiscount()); 
