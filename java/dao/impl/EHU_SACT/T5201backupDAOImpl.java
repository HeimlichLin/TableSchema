...
public class T5201backupDAOImpl extends GeneralDAOImpl<T5201backupPo> implements T5201backupDAO { 
	...
	protected static final MapConverter<T5201backupPo> CONVERTER = new MapConverter<T5201backupPo>() { 
		...
		public T5201backupPo convert(final DataObject dataObject) { 
			...
			t5201backupPo.setBriefnote(dataObject.getString(T5201backupPo.COLUMNS.BRIEFNOTE.name())); 
			t5201backupPo.setSendstatus(dataObject.getString(T5201backupPo.COLUMNS.SENDSTATUS.name())); 
		...
		public DataObject toDataObject(final T5201backupPo t5201backupPo) { 
			...
			dataObject.setValue(T5201backupPo.COLUMNS.BRIEFNOTE.name(), t5201backupPo.getBriefnote()); 
			dataObject.setValue(T5201backupPo.COLUMNS.SENDSTATUS.name(), t5201backupPo.getSendstatus()); 
			return dataObject; 
		} 
