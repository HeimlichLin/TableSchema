...
public class T5107mDAOImpl extends GeneralDAOImpl<T5107mPo> implements T5107mDAO { 
	...
	protected static final MapConverter<T5107mPo> CONVERTER = new MapConverter<T5107mPo>() { 
		...
		public T5107mPo convert(final DataObject dataObject) { 
			...
			t5107mPo.setImportdatetime(dataObject.getString(T5107mPo.COLUMNS.IMPORTDATETIME.name())); 
			...
			t5107mPo.setBaghwb(dataObject.getString(T5107mPo.COLUMNS.BAGHWB.name())); 
			return t5107mPo; 
		} 
		...
		public DataObject toDataObject(final T5107mPo t5107mPo) { 
			...
			dataObject.setValue(T5107mPo.COLUMNS.IMPORTDATETIME.name(), t5107mPo.getImportdatetime()); 
			...
			dataObject.setValue(T5107mPo.COLUMNS.BAGHWB.name(), t5107mPo.getBaghwb()); 
			return dataObject; 
		} 
