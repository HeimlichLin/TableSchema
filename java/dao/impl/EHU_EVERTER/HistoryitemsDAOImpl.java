...
public class HistoryitemsDAOImpl extends GeneralDAOImpl<HistoryitemsPo> implements HistoryitemsDAO { 
	...
	public SqlWhere getPkSqlWhere(HistoryitemsPo po) { 
		...
		sqlWhere.add(HistoryitemsPo.COLUMNS.HWB.name(), po.getHwb()); 
		sqlWhere.add(HistoryitemsPo.COLUMNS.MWB.name(), po.getMwb()); 
		sqlWhere.add(HistoryitemsPo.COLUMNS.ITEMNO.name(), po.getItemno()); 
		return sqlWhere; 
	} 
