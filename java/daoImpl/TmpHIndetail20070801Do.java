...
public class TmpHIndetail20070801DAO extends GeneralDAOImpl<TmpHIndetail20070801Do> implements TmpHIndetail20070801DAO { 
	...
	public SqlWhere getPkSqlWhere(TmpHIndetail20070801Do po) { 
		sqlWhere.add(TmpHIndetail20070801Do.COLUMNS.BONDNO.name(), po.getBondno()); 
		sqlWhere.add(TmpHIndetail20070801Do.COLUMNS.REFBILLNO.name(), po.getRefbillno()); 
		sqlWhere.add(TmpHIndetail20070801Do.COLUMNS.ITEM.name(), po.getItem()); 
		sqlWhere.add(TmpHIndetail20070801Do.COLUMNS.PRDTNO.name(), po.getPrdtno()); 
		sqlWhere.add(TmpHIndetail20070801Do.COLUMNS.RINQTY.name(), po.getRinqty()); 
		sqlWhere.add(TmpHIndetail20070801Do.COLUMNS.INUNIT.name(), po.getInunit()); 
		sqlWhere.add(TmpHIndetail20070801Do.COLUMNS.BALANCE.name(), po.getBalance()); 
		sqlWhere.add(TmpHIndetail20070801Do.COLUMNS.INPOST.name(), po.getInpost()); 
		sqlWhere.add(TmpHIndetail20070801Do.COLUMNS.INDATE.name(), po.getIndate()); 
		sqlWhere.add(TmpHIndetail20070801Do.COLUMNS.BATCHNO.name(), po.getBatchno()); 
		sqlWhere.add(TmpHIndetail20070801Do.COLUMNS.STOCKNO.name(), po.getStockno()); 
		sqlWhere.add(TmpHIndetail20070801Do.COLUMNS.DECLTYPE.name(), po.getDecltype()); 
		sqlWhere.add(TmpHIndetail20070801Do.COLUMNS.DECLNO.name(), po.getDeclno()); 
		sqlWhere.add(TmpHIndetail20070801Do.COLUMNS.ITEMNO.name(), po.getItemno()); 
		sqlWhere.add(TmpHIndetail20070801Do.COLUMNS.OTESTNO.name(), po.getOtestno()); 
		sqlWhere.add(TmpHIndetail20070801Do.COLUMNS.INSTATUS.name(), po.getInstatus()); 
		sqlWhere.add(TmpHIndetail20070801Do.COLUMNS.INRMKS.name(), po.getInrmks()); 
		sqlWhere.add(TmpHIndetail20070801Do.COLUMNS.CONFIRMDATE.name(), po.getConfirmdate()); 
		sqlWhere.add(TmpHIndetail20070801Do.COLUMNS.DESCRIP.name(), po.getDescrip()); 
		sqlWhere.add(TmpHIndetail20070801Do.COLUMNS.MONTHNO.name(), po.getMonthno()); 
		sqlWhere.add(TmpHIndetail20070801Do.COLUMNS.CCCCODE.name(), po.getCcccode()); 
		sqlWhere.add(TmpHIndetail20070801Do.COLUMNS.D8DATE.name(), po.getD8date()); 
		sqlWhere.add(TmpHIndetail20070801Do.COLUMNS.USERID.name(), po.getUserid()); 
		sqlWhere.add(TmpHIndetail20070801Do.COLUMNS.TRADEPRDTNO.name(), po.getTradeprdtno()); 
		sqlWhere.add(TmpHIndetail20070801Do.COLUMNS.UNITPRICE.name(), po.getUnitprice()); 
		sqlWhere.add(TmpHIndetail20070801Do.COLUMNS.NWGHT.name(), po.getNwght()); 
		sqlWhere.add(TmpHIndetail20070801Do.COLUMNS.GROSS.name(), po.getGross()); 
		sqlWhere.add(TmpHIndetail20070801Do.COLUMNS.VALUEAMT.name(), po.getValueamt()); 
		sqlWhere.add(TmpHIndetail20070801Do.COLUMNS.DUTYRATE.name(), po.getDutyrate()); 
		sqlWhere.add(TmpHIndetail20070801Do.COLUMNS.COMDTAXRATE.name(), po.getComdtaxrate()); 
		sqlWhere.add(TmpHIndetail20070801Do.COLUMNS.MDECLNO.name(), po.getMdeclno()); 
		sqlWhere.add(TmpHIndetail20070801Do.COLUMNS.D8DECLNO.name(), po.getD8declno()); 
		sqlWhere.add(TmpHIndetail20070801Do.COLUMNS.OUTSTRNO.name(), po.getOutstrno()); 
		sqlWhere.add(TmpHIndetail20070801Do.COLUMNS.DECLQTY.name(), po.getDeclqty()); 
		sqlWhere.add(TmpHIndetail20070801Do.COLUMNS.RLSTIME.name(), po.getRlstime()); 
		sqlWhere.add(TmpHIndetail20070801Do.COLUMNS.COUNTNO.name(), po.getCountno()); 
		sqlWhere.add(TmpHIndetail20070801Do.COLUMNS.UPDTIME.name(), po.getUpdtime()); 
		sqlWhere.add(TmpHIndetail20070801Do.COLUMNS.ODECLNO.name(), po.getOdeclno()); 
		sqlWhere.add(TmpHIndetail20070801Do.COLUMNS.OITEMNO.name(), po.getOitemno()); 
		sqlWhere.add(TmpHIndetail20070801Do.COLUMNS.INRMKS2.name(), po.getInrmks2()); 
		sqlWhere.add(TmpHIndetail20070801Do.COLUMNS.INVOICE.name(), po.getInvoice()); 
		sqlWhere.add(TmpHIndetail20070801Do.COLUMNS.INVNO.name(), po.getInvno()); 
		sqlWhere.add(TmpHIndetail20070801Do.COLUMNS.DECLDATE.name(), po.getDecldate()); 
	} 
