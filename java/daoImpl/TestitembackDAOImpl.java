...
public class TestitembackDAOImpl extends GeneralDAOImpl<TestitembackDo> implements TestitembackDAOImpl { 
	...
	public SqlWhere getPkSqlWhere(TestitembackDo po) { 
		sqlWhere.add(TestitembackDo.COLUMNS.BONDNO.name(), po.getBondno()); 
		sqlWhere.add(TestitembackDo.COLUMNS.TESTNO.name(), po.getTestno()); 
		sqlWhere.add(TestitembackDo.COLUMNS.PRDTNO.name(), po.getPrdtno()); 
		sqlWhere.add(TestitembackDo.COLUMNS.SERIALNO.name(), po.getSerialno()); 
		sqlWhere.add(TestitembackDo.COLUMNS.ITEM.name(), po.getItem()); 
	} 
