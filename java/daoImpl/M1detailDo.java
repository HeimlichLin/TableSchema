...
public class M1detailDAO extends GeneralDAOImpl<M1detailDo> implements M1detailDAO { 
	...
	public SqlWhere getPkSqlWhere(M1detailDo po) { 
		sqlWhere.add(M1detailDo.COLUMNS.REFBILLNO.name(), po.getRefbillno()); 
		sqlWhere.add(M1detailDo.COLUMNS.ITEM.name(), po.getItem()); 
		sqlWhere.add(M1detailDo.COLUMNS.STRPOST.name(), po.getStrpost()); 
		sqlWhere.add(M1detailDo.COLUMNS.PRDTNO.name(), po.getPrdtno()); 
		sqlWhere.add(M1detailDo.COLUMNS.DECLNO.name(), po.getDeclno()); 
		sqlWhere.add(M1detailDo.COLUMNS.ITEMNO.name(), po.getItemno()); 
		sqlWhere.add(M1detailDo.COLUMNS.STRDATE.name(), po.getStrdate()); 
		sqlWhere.add(M1detailDo.COLUMNS.PROCSTATUS.name(), po.getProcstatus()); 
		sqlWhere.add(M1detailDo.COLUMNS.PROCRMK.name(), po.getProcrmk()); 
		sqlWhere.add(M1detailDo.COLUMNS.PROCUSER.name(), po.getProcuser()); 
		sqlWhere.add(M1detailDo.COLUMNS.CONTROLNO.name(), po.getControlno()); 
	} 
