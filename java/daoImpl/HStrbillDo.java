...
public class HStrbillDAO extends GeneralDAOImpl<HStrbillDo> implements HStrbillDAO { 
	...
	public SqlWhere getPkSqlWhere(HStrbillDo po) { 
		sqlWhere.add(HStrbillDo.COLUMNS.MSGFUN.name(), po.getMsgfun()); 
		sqlWhere.add(HStrbillDo.COLUMNS.GDSTYPE.name(), po.getGdstype()); 
		sqlWhere.add(HStrbillDo.COLUMNS.CTMCODE.name(), po.getCtmcode()); 
		sqlWhere.add(HStrbillDo.COLUMNS.SUBCON.name(), po.getSubcon()); 
		sqlWhere.add(HStrbillDo.COLUMNS.UPDTIME.name(), po.getUpdtime()); 
	} 
