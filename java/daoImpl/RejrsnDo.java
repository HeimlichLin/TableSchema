...
public class RejrsnDAO extends GeneralDAOImpl<RejrsnDo> implements RejrsnDAO { 
	...
	public SqlWhere getPkSqlWhere(RejrsnDo po) { 
		sqlWhere.add(RejrsnDo.COLUMNS.REJNO.name(), po.getRejno()); 
		sqlWhere.add(RejrsnDo.COLUMNS.REJNAME.name(), po.getRejname()); 
	} 
