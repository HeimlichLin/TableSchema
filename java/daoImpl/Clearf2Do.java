...
public class Clearf2DAO extends GeneralDAOImpl<Clearf2Do> implements Clearf2DAO { 
	...
	public SqlWhere getPkSqlWhere(Clearf2Do po) { 
		sqlWhere.add(Clearf2Do.COLUMNS.BONDNO.name(), po.getBondno()); 
		sqlWhere.add(Clearf2Do.COLUMNS.DECLNO.name(), po.getDeclno()); 
		sqlWhere.add(Clearf2Do.COLUMNS.ITEMNO.name(), po.getItemno()); 
		sqlWhere.add(Clearf2Do.COLUMNS.DECLTYPE.name(), po.getDecltype()); 
		sqlWhere.add(Clearf2Do.COLUMNS.PRDTNO.name(), po.getPrdtno()); 
		sqlWhere.add(Clearf2Do.COLUMNS.QTY.name(), po.getQty()); 
		sqlWhere.add(Clearf2Do.COLUMNS.POST.name(), po.getPost()); 
		sqlWhere.add(Clearf2Do.COLUMNS.DUTYTYPE.name(), po.getDutytype()); 
		sqlWhere.add(Clearf2Do.COLUMNS.ODECLNO.name(), po.getOdeclno()); 
		sqlWhere.add(Clearf2Do.COLUMNS.OITEMNO.name(), po.getOitemno()); 
		sqlWhere.add(Clearf2Do.COLUMNS.ODECLTYPE.name(), po.getOdecltype()); 
		sqlWhere.add(Clearf2Do.COLUMNS.OPRDTNO.name(), po.getOprdtno()); 
		sqlWhere.add(Clearf2Do.COLUMNS.OQTY.name(), po.getOqty()); 
		sqlWhere.add(Clearf2Do.COLUMNS.OPOST.name(), po.getOpost()); 
		sqlWhere.add(Clearf2Do.COLUMNS.ODUTYTYPE.name(), po.getOdutytype()); 
		sqlWhere.add(Clearf2Do.COLUMNS.OUTSTATUS.name(), po.getOutstatus()); 
		sqlWhere.add(Clearf2Do.COLUMNS.F4DATE.name(), po.getF4date()); 
		sqlWhere.add(Clearf2Do.COLUMNS.F2DATE.name(), po.getF2date()); 
		sqlWhere.add(Clearf2Do.COLUMNS.UNIT.name(), po.getUnit()); 
		sqlWhere.add(Clearf2Do.COLUMNS.F2UNIT.name(), po.getF2unit()); 
		sqlWhere.add(Clearf2Do.COLUMNS.BOMQUILTY.name(), po.getBomquilty()); 
		sqlWhere.add(Clearf2Do.COLUMNS.BOMQTY.name(), po.getBomqty()); 
	} 
