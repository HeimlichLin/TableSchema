...
public class MicrosoftdtpropertiesDAOImpl extends GeneralDAOImpl<MicrosoftdtpropertiesDo> implements MicrosoftdtpropertiesDAOImpl { 
	...
	public SqlWhere getPkSqlWhere(MicrosoftdtpropertiesDo po) { 
		sqlWhere.add(MicrosoftdtpropertiesDo.COLUMNS.ID.name(), po.getId()); 
		sqlWhere.add(MicrosoftdtpropertiesDo.COLUMNS.PROPERTY.name(), po.getProperty()); 
	} 
