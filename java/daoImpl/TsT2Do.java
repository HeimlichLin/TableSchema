...
public class TsT2DAO extends GeneralDAOImpl<TsT2Do> implements TsT2DAO { 
	...
	public SqlWhere getPkSqlWhere(TsT2Do po) { 
		sqlWhere.add(TsT2Do.COLUMNS.T2ITEM.name(), po.getT2item()); 
		sqlWhere.add(TsT2Do.COLUMNS.T2PRDTNO.name(), po.getT2prdtno()); 
		sqlWhere.add(TsT2Do.COLUMNS.T2RSTRQTY.name(), po.getT2rstrqty()); 
		sqlWhere.add(TsT2Do.COLUMNS.T2PRDTUNIT.name(), po.getT2prdtunit()); 
		sqlWhere.add(TsT2Do.COLUMNS.T2UNITPRICE.name(), po.getT2unitprice()); 
		sqlWhere.add(TsT2Do.COLUMNS.T2ODECLNO.name(), po.getT2odeclno()); 
		sqlWhere.add(TsT2Do.COLUMNS.T2OITEM.name(), po.getT2oitem()); 
		sqlWhere.add(TsT2Do.COLUMNS.T2INPOST.name(), po.getT2inpost()); 
		sqlWhere.add(TsT2Do.COLUMNS.T2OREFBILLNO.name(), po.getT2orefbillno()); 
		sqlWhere.add(TsT2Do.COLUMNS.T2OREFBILLITEM.name(), po.getT2orefbillitem()); 
		sqlWhere.add(TsT2Do.COLUMNS.T2DESCRIP.name(), po.getT2descrip()); 
		sqlWhere.add(TsT2Do.COLUMNS.CONTROLNO.name(), po.getControlno()); 
		sqlWhere.add(TsT2Do.COLUMNS.SERIALNO.name(), po.getSerialno()); 
		sqlWhere.add(TsT2Do.COLUMNS.SEQNO.name(), po.getSeqno()); 
		sqlWhere.add(TsT2Do.COLUMNS.ICONFIRMED.name(), po.getIconfirmed()); 
		sqlWhere.add(TsT2Do.COLUMNS.T1BONDNO.name(), po.getT1bondno()); 
		sqlWhere.add(TsT2Do.COLUMNS.T1TESTNO.name(), po.getT1testno()); 
		sqlWhere.add(TsT2Do.COLUMNS.T1_SEQNO.name(), po.getT1Seqno()); 
	} 
