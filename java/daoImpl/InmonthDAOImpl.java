...
public class InmonthDAOImpl extends GeneralDAOImpl<InmonthDo> implements InmonthDAOImpl { 
	...
	public SqlWhere getPkSqlWhere(InmonthDo po) { 
		sqlWhere.add(InmonthDo.COLUMNS.BONDNO.name(), po.getBondno()); 
		sqlWhere.add(InmonthDo.COLUMNS.MONTHNO.name(), po.getMonthno()); 
		sqlWhere.add(InmonthDo.COLUMNS.ITEM.name(), po.getItem()); 
	} 
