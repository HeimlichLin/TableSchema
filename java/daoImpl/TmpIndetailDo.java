...
public class TmpIndetailDAO extends GeneralDAOImpl<TmpIndetailDo> implements TmpIndetailDAO { 
	...
	public SqlWhere getPkSqlWhere(TmpIndetailDo po) { 
		sqlWhere.add(TmpIndetailDo.COLUMNS.BONDNO.name(), po.getBondno()); 
		sqlWhere.add(TmpIndetailDo.COLUMNS.PRDTNO.name(), po.getPrdtno()); 
		sqlWhere.add(TmpIndetailDo.COLUMNS.INUNIT.name(), po.getInunit()); 
		sqlWhere.add(TmpIndetailDo.COLUMNS.RINQTY.name(), po.getRinqty()); 
		sqlWhere.add(TmpIndetailDo.COLUMNS.DECLTYPE.name(), po.getDecltype()); 
		sqlWhere.add(TmpIndetailDo.COLUMNS.SESSIONID.name(), po.getSessionid()); 
		sqlWhere.add(TmpIndetailDo.COLUMNS.OPTYPENME.name(), po.getOptypenme()); 
	} 
