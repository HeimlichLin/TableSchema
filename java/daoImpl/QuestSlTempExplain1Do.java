...
public class QuestSlTempExplain1DAO extends GeneralDAOImpl<QuestSlTempExplain1Do> implements QuestSlTempExplain1DAO { 
	...
	public SqlWhere getPkSqlWhere(QuestSlTempExplain1Do po) { 
		sqlWhere.add(QuestSlTempExplain1Do.COLUMNS.STATEMENT_ID.name(), po.getStatementId()); 
		sqlWhere.add(QuestSlTempExplain1Do.COLUMNS.PLAN_ID.name(), po.getPlanId()); 
		sqlWhere.add(QuestSlTempExplain1Do.COLUMNS.TIMESTAMP.name(), po.getTimestamp()); 
		sqlWhere.add(QuestSlTempExplain1Do.COLUMNS.REMARKS.name(), po.getRemarks()); 
		sqlWhere.add(QuestSlTempExplain1Do.COLUMNS.OPERATION.name(), po.getOperation()); 
		sqlWhere.add(QuestSlTempExplain1Do.COLUMNS.OPTIONS.name(), po.getOptions()); 
		sqlWhere.add(QuestSlTempExplain1Do.COLUMNS.OBJECT_NODE.name(), po.getObjectNode()); 
		sqlWhere.add(QuestSlTempExplain1Do.COLUMNS.OBJECT_OWNER.name(), po.getObjectOwner()); 
		sqlWhere.add(QuestSlTempExplain1Do.COLUMNS.OBJECT_NAME.name(), po.getObjectName()); 
		sqlWhere.add(QuestSlTempExplain1Do.COLUMNS.OBJECT_ALIAS.name(), po.getObjectAlias()); 
		sqlWhere.add(QuestSlTempExplain1Do.COLUMNS.OBJECT_INSTANCE.name(), po.getObjectInstance()); 
		sqlWhere.add(QuestSlTempExplain1Do.COLUMNS.OBJECT_TYPE.name(), po.getObjectType()); 
		sqlWhere.add(QuestSlTempExplain1Do.COLUMNS.OPTIMIZER.name(), po.getOptimizer()); 
		sqlWhere.add(QuestSlTempExplain1Do.COLUMNS.SEARCH_COLUMNS.name(), po.getSearchColumns()); 
		sqlWhere.add(QuestSlTempExplain1Do.COLUMNS.ID.name(), po.getId()); 
		sqlWhere.add(QuestSlTempExplain1Do.COLUMNS.PARENT_ID.name(), po.getParentId()); 
		sqlWhere.add(QuestSlTempExplain1Do.COLUMNS.DEPTH.name(), po.getDepth()); 
		sqlWhere.add(QuestSlTempExplain1Do.COLUMNS.POSITION.name(), po.getPosition()); 
		sqlWhere.add(QuestSlTempExplain1Do.COLUMNS.COST.name(), po.getCost()); 
		sqlWhere.add(QuestSlTempExplain1Do.COLUMNS.CARDINALITY.name(), po.getCardinality()); 
		sqlWhere.add(QuestSlTempExplain1Do.COLUMNS.BYTES.name(), po.getBytes()); 
		sqlWhere.add(QuestSlTempExplain1Do.COLUMNS.OTHER_TAG.name(), po.getOtherTag()); 
		sqlWhere.add(QuestSlTempExplain1Do.COLUMNS.PARTITION_START.name(), po.getPartitionStart()); 
		sqlWhere.add(QuestSlTempExplain1Do.COLUMNS.PARTITION_STOP.name(), po.getPartitionStop()); 
		sqlWhere.add(QuestSlTempExplain1Do.COLUMNS.PARTITION_ID.name(), po.getPartitionId()); 
		sqlWhere.add(QuestSlTempExplain1Do.COLUMNS.OTHER.name(), po.getOther()); 
		sqlWhere.add(QuestSlTempExplain1Do.COLUMNS.DISTRIBUTION.name(), po.getDistribution()); 
		sqlWhere.add(QuestSlTempExplain1Do.COLUMNS.CPU_COST.name(), po.getCpuCost()); 
		sqlWhere.add(QuestSlTempExplain1Do.COLUMNS.IO_COST.name(), po.getIoCost()); 
		sqlWhere.add(QuestSlTempExplain1Do.COLUMNS.TEMP_SPACE.name(), po.getTempSpace()); 
		sqlWhere.add(QuestSlTempExplain1Do.COLUMNS.ACCESS_PREDICATES.name(), po.getAccessPredicates()); 
		sqlWhere.add(QuestSlTempExplain1Do.COLUMNS.FILTER_PREDICATES.name(), po.getFilterPredicates()); 
	} 
