...
public class InvtrybondDAO extends GeneralDAOImpl<InvtrybondDo> implements InvtrybondDAO { 
	...
	public SqlWhere getPkSqlWhere(InvtrybondDo po) { 
		sqlWhere.add(InvtrybondDo.COLUMNS.BONDNO.name(), po.getBondno()); 
		sqlWhere.add(InvtrybondDo.COLUMNS.YY.name(), po.getYy()); 
		sqlWhere.add(InvtrybondDo.COLUMNS.STRTDATE.name(), po.getStrtdate()); 
		sqlWhere.add(InvtrybondDo.COLUMNS.ENDDATE.name(), po.getEnddate()); 
	} 
