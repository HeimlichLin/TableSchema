...
public class M1headDAOImpl extends GeneralDAOImpl<M1headDo> implements M1headDAOImpl { 
	...
	public SqlWhere getPkSqlWhere(M1headDo po) { 
		sqlWhere.add(M1headDo.COLUMNS.MSGTYPE.name(), po.getMsgtype()); 
		sqlWhere.add(M1headDo.COLUMNS.BONDNO.name(), po.getBondno()); 
		sqlWhere.add(M1headDo.COLUMNS.STRTYPE.name(), po.getStrtype()); 
		sqlWhere.add(M1headDo.COLUMNS.MONTHNO.name(), po.getMonthno()); 
		sqlWhere.add(M1headDo.COLUMNS.PROCTIME.name(), po.getProctime()); 
	} 
