...
public class TmpHDdetail20070801DAO extends GeneralDAOImpl<TmpHDdetail20070801Do> implements TmpHDdetail20070801DAO { 
	...
	public SqlWhere getPkSqlWhere(TmpHDdetail20070801Do po) { 
		sqlWhere.add(TmpHDdetail20070801Do.COLUMNS.BONDNO.name(), po.getBondno()); 
		sqlWhere.add(TmpHDdetail20070801Do.COLUMNS.DECLNO.name(), po.getDeclno()); 
		sqlWhere.add(TmpHDdetail20070801Do.COLUMNS.ITEMNO.name(), po.getItemno()); 
		sqlWhere.add(TmpHDdetail20070801Do.COLUMNS.PRDTNO.name(), po.getPrdtno()); 
		sqlWhere.add(TmpHDdetail20070801Do.COLUMNS.DESCRIP.name(), po.getDescrip()); 
		sqlWhere.add(TmpHDdetail20070801Do.COLUMNS.BRAND.name(), po.getBrand()); 
		sqlWhere.add(TmpHDdetail20070801Do.COLUMNS.MODEL.name(), po.getModel()); 
		sqlWhere.add(TmpHDdetail20070801Do.COLUMNS.SPEC.name(), po.getSpec()); 
		sqlWhere.add(TmpHDdetail20070801Do.COLUMNS.NWGHT.name(), po.getNwght()); 
		sqlWhere.add(TmpHDdetail20070801Do.COLUMNS.QTY.name(), po.getQty()); 
		sqlWhere.add(TmpHDdetail20070801Do.COLUMNS.UNIT.name(), po.getUnit()); 
		sqlWhere.add(TmpHDdetail20070801Do.COLUMNS.UPRICE.name(), po.getUprice()); 
		sqlWhere.add(TmpHDdetail20070801Do.COLUMNS.CUR.name(), po.getCur()); 
		sqlWhere.add(TmpHDdetail20070801Do.COLUMNS.VALUEAMT.name(), po.getValueamt()); 
		sqlWhere.add(TmpHDdetail20070801Do.COLUMNS.VALUEQTY.name(), po.getValueqty()); 
		sqlWhere.add(TmpHDdetail20070801Do.COLUMNS.DUTYRATE.name(), po.getDutyrate()); 
		sqlWhere.add(TmpHDdetail20070801Do.COLUMNS.UNITDUTY.name(), po.getUnitduty()); 
		sqlWhere.add(TmpHDdetail20070801Do.COLUMNS.ODECLNO.name(), po.getOdeclno()); 
		sqlWhere.add(TmpHDdetail20070801Do.COLUMNS.OITEMNO.name(), po.getOitemno()); 
		sqlWhere.add(TmpHDdetail20070801Do.COLUMNS.CCCCODE.name(), po.getCcccode()); 
		sqlWhere.add(TmpHDdetail20070801Do.COLUMNS.COMDTAXRATE.name(), po.getComdtaxrate()); 
		sqlWhere.add(TmpHDdetail20070801Do.COLUMNS.STRTYPE.name(), po.getStrtype()); 
		sqlWhere.add(TmpHDdetail20070801Do.COLUMNS.UPDTIME.name(), po.getUpdtime()); 
		sqlWhere.add(TmpHDdetail20070801Do.COLUMNS.DUTYTYPE.name(), po.getDutytype()); 
		sqlWhere.add(TmpHDdetail20070801Do.COLUMNS.STATMODE.name(), po.getStatmode()); 
		sqlWhere.add(TmpHDdetail20070801Do.COLUMNS.MSGTYPE.name(), po.getMsgtype()); 
		sqlWhere.add(TmpHDdetail20070801Do.COLUMNS.D8DATE.name(), po.getD8date()); 
		sqlWhere.add(TmpHDdetail20070801Do.COLUMNS.PRODCOUNTRY.name(), po.getProdcountry()); 
	} 
