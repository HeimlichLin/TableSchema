...
public class TsT1DAO extends GeneralDAOImpl<TsT1Do> implements TsT1DAO { 
	...
	public SqlWhere getPkSqlWhere(TsT1Do po) { 
		sqlWhere.add(TsT1Do.COLUMNS.T1BONDNO.name(), po.getT1bondno()); 
		sqlWhere.add(TsT1Do.COLUMNS.T1TESTNO.name(), po.getT1testno()); 
		sqlWhere.add(TsT1Do.COLUMNS.T1CTMCODE.name(), po.getT1ctmcode()); 
		sqlWhere.add(TsT1Do.COLUMNS.T1REQRDATE.name(), po.getT1reqrdate()); 
		sqlWhere.add(TsT1Do.COLUMNS.T1APPLYDATE.name(), po.getT1applydate()); 
		sqlWhere.add(TsT1Do.COLUMNS.T1APPROVEDDATE.name(), po.getT1approveddate()); 
		sqlWhere.add(TsT1Do.COLUMNS.T1APPROVEDNO.name(), po.getT1approvedno()); 
		sqlWhere.add(TsT1Do.COLUMNS.T1DESTPLACE.name(), po.getT1destplace()); 
		sqlWhere.add(TsT1Do.COLUMNS.T1TESTTYPE.name(), po.getT1testtype()); 
		sqlWhere.add(TsT1Do.COLUMNS.T1STRTYPE.name(), po.getT1strtype()); 
		sqlWhere.add(TsT1Do.COLUMNS.CONTROLNO.name(), po.getControlno()); 
		sqlWhere.add(TsT1Do.COLUMNS.SERIALNO.name(), po.getSerialno()); 
		sqlWhere.add(TsT1Do.COLUMNS.SEQNO.name(), po.getSeqno()); 
		sqlWhere.add(TsT1Do.COLUMNS.ICONFIRMED.name(), po.getIconfirmed()); 
	} 
