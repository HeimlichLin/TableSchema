...
public class CtmcodeDAOImpl extends GeneralDAOImpl<CtmcodeDo> implements CtmcodeDAOImpl { 
	...
	public SqlWhere getPkSqlWhere(CtmcodeDo po) { 
		sqlWhere.add(CtmcodeDo.COLUMNS.BONDNO.name(), po.getBondno()); 
		sqlWhere.add(CtmcodeDo.COLUMNS.CTMCODE.name(), po.getCtmcode()); 
	} 
