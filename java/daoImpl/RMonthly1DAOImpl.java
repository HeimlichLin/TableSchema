...
public class RMonthly1DAOImpl extends GeneralDAOImpl<RMonthly1Do> implements RMonthly1DAOImpl { 
	...
	public SqlWhere getPkSqlWhere(RMonthly1Do po) { 
		sqlWhere.add(RMonthly1Do.COLUMNS.SESSIONID.name(), po.getSessionid()); 
		sqlWhere.add(RMonthly1Do.COLUMNS.BONDNO.name(), po.getBondno()); 
		sqlWhere.add(RMonthly1Do.COLUMNS.GDSTYPE.name(), po.getGdstype()); 
		sqlWhere.add(RMonthly1Do.COLUMNS.PRDTNO.name(), po.getPrdtno()); 
		sqlWhere.add(RMonthly1Do.COLUMNS.DECLNO.name(), po.getDeclno()); 
		sqlWhere.add(RMonthly1Do.COLUMNS.ITEMNO.name(), po.getItemno()); 
		sqlWhere.add(RMonthly1Do.COLUMNS.INDATE.name(), po.getIndate()); 
		sqlWhere.add(RMonthly1Do.COLUMNS.UNIT.name(), po.getUnit()); 
		sqlWhere.add(RMonthly1Do.COLUMNS.RQTY.name(), po.getRqty()); 
		sqlWhere.add(RMonthly1Do.COLUMNS.POST.name(), po.getPost()); 
		sqlWhere.add(RMonthly1Do.COLUMNS.REFBILLNO.name(), po.getRefbillno()); 
		sqlWhere.add(RMonthly1Do.COLUMNS.DECLTYPE.name(), po.getDecltype()); 
		sqlWhere.add(RMonthly1Do.COLUMNS.ID.name(), po.getId()); 
		sqlWhere.add(RMonthly1Do.COLUMNS.ITEM.name(), po.getItem()); 
	} 
