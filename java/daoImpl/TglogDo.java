...
public class TglogDAO extends GeneralDAOImpl<TglogDo> implements TglogDAO { 
	...
	public SqlWhere getPkSqlWhere(TglogDo po) { 
		sqlWhere.add(TglogDo.COLUMNS.LOG_PGM.name(), po.getLogPgm()); 
		sqlWhere.add(TglogDo.COLUMNS.LOG_ACTION.name(), po.getLogAction()); 
		sqlWhere.add(TglogDo.COLUMNS.LOG_ERROR.name(), po.getLogError()); 
		sqlWhere.add(TglogDo.COLUMNS.LOG_DATM.name(), po.getLogDatm()); 
		sqlWhere.add(TglogDo.COLUMNS.LOG1.name(), po.getLog1()); 
		sqlWhere.add(TglogDo.COLUMNS.LOG2.name(), po.getLog2()); 
		sqlWhere.add(TglogDo.COLUMNS.LOG3.name(), po.getLog3()); 
	} 
