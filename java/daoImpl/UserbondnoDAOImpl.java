...
public class UserbondnoDAOImpl extends GeneralDAOImpl<UserbondnoDo> implements UserbondnoDAOImpl { 
	...
	public SqlWhere getPkSqlWhere(UserbondnoDo po) { 
		sqlWhere.add(UserbondnoDo.COLUMNS.USERID.name(), po.getUserid()); 
		sqlWhere.add(UserbondnoDo.COLUMNS.BONDNO.name(), po.getBondno()); 
	} 
