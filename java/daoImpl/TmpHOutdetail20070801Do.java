...
public class TmpHOutdetail20070801DAO extends GeneralDAOImpl<TmpHOutdetail20070801Do> implements TmpHOutdetail20070801DAO { 
	...
	public SqlWhere getPkSqlWhere(TmpHOutdetail20070801Do po) { 
		sqlWhere.add(TmpHOutdetail20070801Do.COLUMNS.BONDNO.name(), po.getBondno()); 
		sqlWhere.add(TmpHOutdetail20070801Do.COLUMNS.REFBILLNO.name(), po.getRefbillno()); 
		sqlWhere.add(TmpHOutdetail20070801Do.COLUMNS.ITEM.name(), po.getItem()); 
		sqlWhere.add(TmpHOutdetail20070801Do.COLUMNS.PRDTNO.name(), po.getPrdtno()); 
		sqlWhere.add(TmpHOutdetail20070801Do.COLUMNS.ROUTQTY.name(), po.getRoutqty()); 
		sqlWhere.add(TmpHOutdetail20070801Do.COLUMNS.OUTUNIT.name(), po.getOutunit()); 
		sqlWhere.add(TmpHOutdetail20070801Do.COLUMNS.OUTPOST.name(), po.getOutpost()); 
		sqlWhere.add(TmpHOutdetail20070801Do.COLUMNS.OUTDATE.name(), po.getOutdate()); 
		sqlWhere.add(TmpHOutdetail20070801Do.COLUMNS.BATCHNO.name(), po.getBatchno()); 
		sqlWhere.add(TmpHOutdetail20070801Do.COLUMNS.STOCKNO.name(), po.getStockno()); 
		sqlWhere.add(TmpHOutdetail20070801Do.COLUMNS.DECLTYPE.name(), po.getDecltype()); 
		sqlWhere.add(TmpHOutdetail20070801Do.COLUMNS.DECLNO.name(), po.getDeclno()); 
		sqlWhere.add(TmpHOutdetail20070801Do.COLUMNS.ITEMNO.name(), po.getItemno()); 
		sqlWhere.add(TmpHOutdetail20070801Do.COLUMNS.ODECLNO.name(), po.getOdeclno()); 
		sqlWhere.add(TmpHOutdetail20070801Do.COLUMNS.OITEMNO.name(), po.getOitemno()); 
		sqlWhere.add(TmpHOutdetail20070801Do.COLUMNS.OUTSTATUS.name(), po.getOutstatus()); 
		sqlWhere.add(TmpHOutdetail20070801Do.COLUMNS.OUTRMKS.name(), po.getOutrmks()); 
		sqlWhere.add(TmpHOutdetail20070801Do.COLUMNS.CONFIRMDATE.name(), po.getConfirmdate()); 
		sqlWhere.add(TmpHOutdetail20070801Do.COLUMNS.DESCRIP.name(), po.getDescrip()); 
		sqlWhere.add(TmpHOutdetail20070801Do.COLUMNS.MONTHNO.name(), po.getMonthno()); 
		sqlWhere.add(TmpHOutdetail20070801Do.COLUMNS.USERID.name(), po.getUserid()); 
		sqlWhere.add(TmpHOutdetail20070801Do.COLUMNS.TRADEPRDTNO.name(), po.getTradeprdtno()); 
		sqlWhere.add(TmpHOutdetail20070801Do.COLUMNS.NWGHT.name(), po.getNwght()); 
		sqlWhere.add(TmpHOutdetail20070801Do.COLUMNS.GROSS.name(), po.getGross()); 
		sqlWhere.add(TmpHOutdetail20070801Do.COLUMNS.OUTSTRNO.name(), po.getOutstrno()); 
		sqlWhere.add(TmpHOutdetail20070801Do.COLUMNS.UNITPRICE.name(), po.getUnitprice()); 
		sqlWhere.add(TmpHOutdetail20070801Do.COLUMNS.CCCCODE.name(), po.getCcccode()); 
		sqlWhere.add(TmpHOutdetail20070801Do.COLUMNS.RLSTIME.name(), po.getRlstime()); 
		sqlWhere.add(TmpHOutdetail20070801Do.COLUMNS.DUTYRATE.name(), po.getDutyrate()); 
		sqlWhere.add(TmpHOutdetail20070801Do.COLUMNS.PONO.name(), po.getPono()); 
		sqlWhere.add(TmpHOutdetail20070801Do.COLUMNS.INVNO.name(), po.getInvno()); 
		sqlWhere.add(TmpHOutdetail20070801Do.COLUMNS.COUNTNO.name(), po.getCountno()); 
		sqlWhere.add(TmpHOutdetail20070801Do.COLUMNS.UPDTIME.name(), po.getUpdtime()); 
		sqlWhere.add(TmpHOutdetail20070801Do.COLUMNS.OUTRMKS2.name(), po.getOutrmks2()); 
		sqlWhere.add(TmpHOutdetail20070801Do.COLUMNS.OREFBILLNO.name(), po.getOrefbillno()); 
		sqlWhere.add(TmpHOutdetail20070801Do.COLUMNS.OITEM.name(), po.getOitem()); 
		sqlWhere.add(TmpHOutdetail20070801Do.COLUMNS.DECLDATE.name(), po.getDecldate()); 
		sqlWhere.add(TmpHOutdetail20070801Do.COLUMNS.INVOICE.name(), po.getInvoice()); 
		sqlWhere.add(TmpHOutdetail20070801Do.COLUMNS.MOITEMNO.name(), po.getMoitemno()); 
	} 
