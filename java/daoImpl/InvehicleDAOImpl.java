...
public class InvehicleDAOImpl extends GeneralDAOImpl<InvehicleDo> implements InvehicleDAOImpl { 
	...
	public SqlWhere getPkSqlWhere(InvehicleDo po) { 
		...
		sqlWhere.add(InvehicleDo.COLUMNS.BONDNO.name(), po.getBondno()); 
		sqlWhere.add(InvehicleDo.COLUMNS.DECLNO.name(), po.getDeclno()); 
		sqlWhere.add(InvehicleDo.COLUMNS.ITEMNO.name(), po.getItemno()); 
		sqlWhere.add(InvehicleDo.COLUMNS.VEHICLENO.name(), po.getVehicleno()); 
		return sqlWhere; 
	} 
