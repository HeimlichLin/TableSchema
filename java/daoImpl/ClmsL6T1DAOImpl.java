...
public class ClmsL6T1DAOImpl extends GeneralDAOImpl<ClmsL6T1Do> implements ClmsL6T1DAOImpl { 
	...
	public SqlWhere getPkSqlWhere(ClmsL6T1Do po) { 
		sqlWhere.add(ClmsL6T1Do.COLUMNS.BONDNO.name(), po.getBondno()); 
		sqlWhere.add(ClmsL6T1Do.COLUMNS.REF_BILL_NO.name(), po.getRefBillNo()); 
		sqlWhere.add(ClmsL6T1Do.COLUMNS.ITEM.name(), po.getItem()); 
		sqlWhere.add(ClmsL6T1Do.COLUMNS.OIL_POST.name(), po.getOilPost()); 
		sqlWhere.add(ClmsL6T1Do.COLUMNS.NEW_POST.name(), po.getNewPost()); 
		sqlWhere.add(ClmsL6T1Do.COLUMNS.CONTROL_NO.name(), po.getControlNo()); 
		sqlWhere.add(ClmsL6T1Do.COLUMNS.VERSION.name(), po.getVersion()); 
		sqlWhere.add(ClmsL6T1Do.COLUMNS.SEQ_NO.name(), po.getSeqNo()); 
	} 
