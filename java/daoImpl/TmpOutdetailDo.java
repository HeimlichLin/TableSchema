...
public class TmpOutdetailDAO extends GeneralDAOImpl<TmpOutdetailDo> implements TmpOutdetailDAO { 
	...
	public SqlWhere getPkSqlWhere(TmpOutdetailDo po) { 
		sqlWhere.add(TmpOutdetailDo.COLUMNS.BONDNO.name(), po.getBondno()); 
		sqlWhere.add(TmpOutdetailDo.COLUMNS.PRDTNO.name(), po.getPrdtno()); 
		sqlWhere.add(TmpOutdetailDo.COLUMNS.OUTUNIT.name(), po.getOutunit()); 
		sqlWhere.add(TmpOutdetailDo.COLUMNS.OUTQTY.name(), po.getOutqty()); 
		sqlWhere.add(TmpOutdetailDo.COLUMNS.DECLTYPE.name(), po.getDecltype()); 
		sqlWhere.add(TmpOutdetailDo.COLUMNS.IDECLTYPE.name(), po.getIdecltype()); 
		sqlWhere.add(TmpOutdetailDo.COLUMNS.PROCESS.name(), po.getProcess()); 
		sqlWhere.add(TmpOutdetailDo.COLUMNS.BOMRATE.name(), po.getBomrate()); 
		sqlWhere.add(TmpOutdetailDo.COLUMNS.SESSIONID.name(), po.getSessionid()); 
		sqlWhere.add(TmpOutdetailDo.COLUMNS.PARTNO.name(), po.getPartno()); 
		sqlWhere.add(TmpOutdetailDo.COLUMNS.OPTYPENME.name(), po.getOptypenme()); 
	} 
