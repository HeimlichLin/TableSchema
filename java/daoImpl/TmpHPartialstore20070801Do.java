...
public class TmpHPartialstore20070801DAO extends GeneralDAOImpl<TmpHPartialstore20070801Do> implements TmpHPartialstore20070801DAO { 
	...
	public SqlWhere getPkSqlWhere(TmpHPartialstore20070801Do po) { 
		sqlWhere.add(TmpHPartialstore20070801Do.COLUMNS.MSGFUN.name(), po.getMsgfun()); 
		sqlWhere.add(TmpHPartialstore20070801Do.COLUMNS.BONDNO.name(), po.getBondno()); 
		sqlWhere.add(TmpHPartialstore20070801Do.COLUMNS.REFBILLNO.name(), po.getRefbillno()); 
		sqlWhere.add(TmpHPartialstore20070801Do.COLUMNS.CTMCODE.name(), po.getCtmcode()); 
		sqlWhere.add(TmpHPartialstore20070801Do.COLUMNS.REFERCODE.name(), po.getRefercode()); 
		sqlWhere.add(TmpHPartialstore20070801Do.COLUMNS.ITEM.name(), po.getItem()); 
		sqlWhere.add(TmpHPartialstore20070801Do.COLUMNS.PRDTNO.name(), po.getPrdtno()); 
		sqlWhere.add(TmpHPartialstore20070801Do.COLUMNS.STRTYPE.name(), po.getStrtype()); 
		sqlWhere.add(TmpHPartialstore20070801Do.COLUMNS.GDSTYPE.name(), po.getGdstype()); 
		sqlWhere.add(TmpHPartialstore20070801Do.COLUMNS.RSTRQTY.name(), po.getRstrqty()); 
		sqlWhere.add(TmpHPartialstore20070801Do.COLUMNS.STRUNIT.name(), po.getStrunit()); 
		sqlWhere.add(TmpHPartialstore20070801Do.COLUMNS.STRPOST.name(), po.getStrpost()); 
		sqlWhere.add(TmpHPartialstore20070801Do.COLUMNS.STRDATE.name(), po.getStrdate()); 
		sqlWhere.add(TmpHPartialstore20070801Do.COLUMNS.BATCHNO.name(), po.getBatchno()); 
		sqlWhere.add(TmpHPartialstore20070801Do.COLUMNS.STOCKNO.name(), po.getStockno()); 
		sqlWhere.add(TmpHPartialstore20070801Do.COLUMNS.OUTSTRNO.name(), po.getOutstrno()); 
		sqlWhere.add(TmpHPartialstore20070801Do.COLUMNS.DECLTYPE.name(), po.getDecltype()); 
		sqlWhere.add(TmpHPartialstore20070801Do.COLUMNS.DECLNO.name(), po.getDeclno()); 
		sqlWhere.add(TmpHPartialstore20070801Do.COLUMNS.ITEMNO.name(), po.getItemno()); 
		sqlWhere.add(TmpHPartialstore20070801Do.COLUMNS.ODECLNO.name(), po.getOdeclno()); 
		sqlWhere.add(TmpHPartialstore20070801Do.COLUMNS.OITEMNO.name(), po.getOitemno()); 
		sqlWhere.add(TmpHPartialstore20070801Do.COLUMNS.REALSTATUS.name(), po.getRealstatus()); 
		sqlWhere.add(TmpHPartialstore20070801Do.COLUMNS.MONTHNO.name(), po.getMonthno()); 
		sqlWhere.add(TmpHPartialstore20070801Do.COLUMNS.USERID.name(), po.getUserid()); 
		sqlWhere.add(TmpHPartialstore20070801Do.COLUMNS.UPDTIME.name(), po.getUpdtime()); 
		sqlWhere.add(TmpHPartialstore20070801Do.COLUMNS.CONFIRMDATE.name(), po.getConfirmdate()); 
	} 
