...
public class InUps1DAO extends GeneralDAOImpl<InUps1Do> implements InUps1DAO { 
	...
	public SqlWhere getPkSqlWhere(InUps1Do po) { 
		sqlWhere.add(InUps1Do.COLUMNS.BONDNO.name(), po.getBondno()); 
		sqlWhere.add(InUps1Do.COLUMNS.GDSTYPE.name(), po.getGdstype()); 
		sqlWhere.add(InUps1Do.COLUMNS.DECLTYPE.name(), po.getDecltype()); 
		sqlWhere.add(InUps1Do.COLUMNS.PRDTNO.name(), po.getPrdtno()); 
		sqlWhere.add(InUps1Do.COLUMNS.DECLNO.name(), po.getDeclno()); 
		sqlWhere.add(InUps1Do.COLUMNS.ITEMNO.name(), po.getItemno()); 
		sqlWhere.add(InUps1Do.COLUMNS.STOCKNO.name(), po.getStockno()); 
		sqlWhere.add(InUps1Do.COLUMNS.INDATE.name(), po.getIndate()); 
		sqlWhere.add(InUps1Do.COLUMNS.RINQTY.name(), po.getRinqty()); 
		sqlWhere.add(InUps1Do.COLUMNS.INUNIT.name(), po.getInunit()); 
		sqlWhere.add(InUps1Do.COLUMNS.INPOST.name(), po.getInpost()); 
		sqlWhere.add(InUps1Do.COLUMNS.BALANCE.name(), po.getBalance()); 
		sqlWhere.add(InUps1Do.COLUMNS.ISSTOCK.name(), po.getIsstock()); 
		sqlWhere.add(InUps1Do.COLUMNS.RMK.name(), po.getRmk()); 
		sqlWhere.add(InUps1Do.COLUMNS.INSTATUS.name(), po.getInstatus()); 
		sqlWhere.add(InUps1Do.COLUMNS.CONTROLNO.name(), po.getControlno()); 
		sqlWhere.add(InUps1Do.COLUMNS.UPDTIME.name(), po.getUpdtime()); 
	} 
