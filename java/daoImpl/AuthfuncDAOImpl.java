...
public class AuthfuncDAOImpl extends GeneralDAOImpl<AuthfuncDo> implements AuthfuncDAOImpl { 
	...
	public SqlWhere getPkSqlWhere(AuthfuncDo po) { 
		sqlWhere.add(AuthfuncDo.COLUMNS.AUTHID.name(), po.getAuthid()); 
		sqlWhere.add(AuthfuncDo.COLUMNS.FUNCID.name(), po.getFuncid()); 
	} 
