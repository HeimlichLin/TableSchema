...
public class HVehicleDAOImpl extends GeneralDAOImpl<HVehicleDo> implements HVehicleDAOImpl { 
	...
	public SqlWhere getPkSqlWhere(HVehicleDo po) { 
		sqlWhere.add(HVehicleDo.COLUMNS.BONDNO.name(), po.getBondno()); 
		sqlWhere.add(HVehicleDo.COLUMNS.DECLNO.name(), po.getDeclno()); 
		sqlWhere.add(HVehicleDo.COLUMNS.ITEMNO.name(), po.getItemno()); 
		sqlWhere.add(HVehicleDo.COLUMNS.VEHICLENO.name(), po.getVehicleno()); 
	} 
