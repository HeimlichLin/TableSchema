...
public class OutmonthDAOImpl extends GeneralDAOImpl<OutmonthDo> implements OutmonthDAOImpl { 
	...
	public SqlWhere getPkSqlWhere(OutmonthDo po) { 
		sqlWhere.add(OutmonthDo.COLUMNS.BONDNO.name(), po.getBondno()); 
		sqlWhere.add(OutmonthDo.COLUMNS.MONTHNO.name(), po.getMonthno()); 
		sqlWhere.add(OutmonthDo.COLUMNS.ITEM.name(), po.getItem()); 
	} 
