...
public class AccessCodeDAO extends GeneralDAOImpl<AccessCodeDo> implements AccessCodeDAO { 
	...
	public SqlWhere getPkSqlWhere(AccessCodeDo po) { 
		sqlWhere.add(AccessCodeDo.COLUMNS.CREATE_DATE.name(), po.getCreateDate()); 
		sqlWhere.add(AccessCodeDo.COLUMNS.EXPIRED_DATE.name(), po.getExpiredDate()); 
		sqlWhere.add(AccessCodeDo.COLUMNS.STATUS.name(), po.getStatus()); 
		sqlWhere.add(AccessCodeDo.COLUMNS.USER_ID.name(), po.getUserId()); 
		sqlWhere.add(AccessCodeDo.COLUMNS.REG_REMOTE_ADDR.name(), po.getRegRemoteAddr()); 
		sqlWhere.add(AccessCodeDo.COLUMNS.LAST_ACC_REMOTE_ADDR.name(), po.getLastAccRemoteAddr()); 
		sqlWhere.add(AccessCodeDo.COLUMNS.LAST_ACC_DATE.name(), po.getLastAccDate()); 
	} 
